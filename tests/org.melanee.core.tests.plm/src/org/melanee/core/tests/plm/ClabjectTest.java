...
public class ClabjectTest {
  ...
  public void testGetSupertypes() {
    ...
    assertTrue("Result of c.getSupertypes() must be supertype",
        c.getSupertypes().contains(supertype));
    ...
    assertTrue("Result of c.getSupertypes() must be supertype and supertype2",
        (c.getSupertypes().contains(supertype) && c.getSupertypes().contains(supertype2)));
    ...
    assertTrue("Result of c2.getDirectSupertypes() must be c",
        (c2.getDirectSupertypes().contains(c)));
    assertTrue("Result of c2.getSupertypes() must be c, supertype and supertype2",
        (c2.getSupertypes().contains(supertype) && c2.getSupertypes().contains(supertype2)
            && c2.getSupertypes().contains(c)));
  }
  ...
  public void testGetSubtypes() {
    ...
    assertTrue("Result of supertype.getSubtypes() must be c and c2",
        (supertype.getSubtypes().contains(c) && supertype.getSubtypes().contains(c2)));
  }
  ...
  public void testGetHollowTypes() {
    ...
    // test
    assertTrue("Result of person1.getHollowSubtypes() must be employee1+2",
        (person1.getHollowSubtypes().contains(employee1)
            && person1.getHollowSubtypes().contains(employee2)));
    assertTrue("Result of employee3.getHollowSupertypes() must be person2",
        (employee3.getHollowSupertypes().contains(person2)));
    assertTrue("Result of employee1.getHollowSupertypes() must be person1+2",
        (employee1.getHollowSupertypes().contains(person2)
  ...
  public void testGetClassifications() {
    ...
    assertTrue("The Result of c.getClassificationsAsInstance() should be empty",
        c.getClassificationsAsInstance().isEmpty());
    assertTrue("The Result of c.getClassificationsAsType() should be empty",
        c.getClassificationsAsType().isEmpty());
    ...
    assertTrue("The Result of c.getClassificationsAsType() should be classi",
        c.getClassificationsAsType().contains(classi));
    assertTrue("The Result of c.getClassificationsAsInstance() should be empty",
        c.getClassificationsAsInstance().isEmpty());
    assertTrue("The Result of d.getClassificationsAsInstance() should be classi",
        d.getClassificationsAsInstance().contains(classi));
    assertTrue("The Result of d.getClassificationsAsType() should be empty",
        d.getClassificationsAsType().isEmpty());
  ...
  public void testGetInstances() {
    ...
    // To do: OCL von getDirectInstances() in getInstances() schreiben und
    // getDirectInstances() l�schen
    // nur ein Level tief
  ...
  public void testGetTypes() {
    ...
    // To do: OCL von getDirectTypes() in getTypes() schreiben und getDirectTypes()
    // l�schen
  ...
  public void testGetLevelTypes() {
    ...
    // Name f�r diese Funktion angepasst? Sie gibt alle Clabjects zur�ck, die �ber
    // eine Classification mit self verbunden ist
    // auch solche, die selbst keine Classification zu self haben aber deren
    // Subtypes --> mit Level hat das nichts zu tun meiner Meinung nach
    ...
    assertTrue("The Result of e.getLevelTypes() should be d and c",
        e.getLevelTypes().contains(d) && e.getLevelTypes().contains(c));
  }
  ...
  public void testGetClassificationTreeAsInstance() {
    ...
    // im Gegensatz zu getTypes(), wo nur eine Ebene obendr�ber genommen wird,
    // werden hier alle Ebenen obendr�ber genommen
    ...
    assertTrue("The Result of e.getClassificationTreeAsInstance() should be d and c",
        e.getClassificationTreeAsInstance().contains(d)
            && e.getClassificationTreeAsInstance().contains(c));
  ...
  public void testGetDefinedInstances() {
    ...
    assertTrue("The Result of c.getEigenInstances() should be empty",
        c.getDefinedInstances().isEmpty());
  ...
  public void testGetEigenClassificationTreeAsType() {
    ...
    assertTrue("The Result of c.getEigenClassificationTreeAsType() should be d,e,f,g,h and i",
        c.getDefinedClassificationTreeAsType().contains(d)
            && c.getDefinedClassificationTreeAsType().contains(e)
            && c.getDefinedClassificationTreeAsType().contains(f)
            && c.getDefinedClassificationTreeAsType().contains(g)
            && c.getDefinedClassificationTreeAsType().contains(h)
            && c.getDefinedClassificationTreeAsType().contains(i));
  }
  ...
  public void testGetClassificationTreeAsType() {
    ...
    // to do: dem namen zu folge hatte ich erwartet, dass ich alle nachfolgenden
    // clabjects bekomme,
    // mit dieser Funktion werden aber nur zwei levels unter self beachtet weil
    // getInstances() immer nur ein Level tiefer geht!!!
    ...
    assertTrue("The Result of c.getClassificationTreeAsType() should be d and e",
        c.getClassificationTreeAsType().contains(d) && c.getClassificationTreeAsType().contains(e));
    // & c.getClassificationTreeAsType().contains(f));

  }

  // toDo: getClassificationTreeAsType(EInt) and getClassificationTreeAsType(EInt,
  // EInt)
  ...
  public void testGetAllFeatures() {
    ...
    // in features->select(f | features->excluding(f)->forAll(f2 | f.name = f2.name
    // implies not
    // f.getClabject().getSubtypes()->includes(f2.getClabject())))->asOrderedSet()

    // also tested here: Clabject.getAllAttributes(), Clabject.getAllMethods(),
    // Clabject.getEigenAttributes() and
    ...
    assertTrue(
        "The Result of person2.getAllFeatures() should be attribute name and id / method getName() and getID()",
        person2.getAllFeatures().contains(id) && person2.getAllFeatures().contains(getID)
            && person2.getAllFeatures().contains(name)
            && person2.getAllFeatures().contains(getName));
    ...
    assertTrue("The Result of person2.getDefinedAttributes() should be attribute id",
        person2.getDefinedAttributes().contains(id)
            && !person2.getDefinedAttributes().contains(name));
    ...
    assertTrue("The Result of person2.getEigenMethods() should be method getID",
        person2.getDefinedMethods().contains(getID)
            && !person2.getDefinedMethods().contains(getName));
    ...
    assertTrue("The Result of person3.getAllAttributes() should be attribute name and id2",
        person3.getAllAttributes().contains(name) && person3.getAllAttributes().contains(id2)
            && !person3.getAllAttributes().contains(id));

    assertTrue("The Result of person3.getAllMethods() should be method getName and getID2",
        person3.getAllMethods().contains(getID2) && person3.getAllMethods().contains(getName)
            && !person3.getAllMethods().contains(getID));
  ...
  // to do: Clabject.isContainerOf(Clabject) and Clabject.getContainer() and
  // Clabject.getOwner()

  @Test
  public void testGetEigenConnections() {
    // OCL expression:
    // ConnectionEnd.allInstances()->select(r | r.destination =
    ...
    assertTrue("The Result of d.getEigenConnections() should be connect and connect2",
        d.getDefinedConnections().contains(connect)
            && d.getDefinedConnections().contains(connect2));
  ...
  public void testGetIsonymHyponymBlueprintOffspring() {
    ...
    // self.getClassificationsAsType()->select(c | c.kind =
    ...
    // self.getClassificationsAsInstance()->select((kind=
    // ClassificationKind::isonym) or (kind=
    // ClassificationKind::instantiation)).type->asSet()
    assertTrue("The Result of d.getLevelCompleteTypes() should be c",
        d.getLevelCompleteTypes().contains(c));
    ...
    assertTrue("The Result of d.getLevelIncompleteTypes() should be c",
        d.getLevelIncompleteTypes().contains(c));
  ...
  public void testGetInheritancesAsSubtype() {
    ...
    // try {OCLHelper.execute(c,
    // "Inheritance.allInstances()->select(g|g.subtype->includes(self))");
    // } catch (ParserException e1) {
    // e1.printStackTrace();
    // }

    assertTrue("Result of c.getInheritancesAsSubtype() must be connect and connect2",
        c.getInheritancesAsSubtype().contains(connect)
            && c.getInheritancesAsSubtype().contains(connect2));
    assertTrue("Result of c.getInheritancesAsSupertype() must be connect3 and connect4",
        c.getInheritancesAsSupertype().contains(connect3)
            && c.getInheritancesAsSupertype().contains(connect4));
  }

  @Test
  public void testGetNavigations() {
    // getEigenNavigations(), getInheritedNavigations() and getAllNavigations() -
    ...
    // connection between c and d0 - not navigable and therefore not element of the
    // result
    ...
    // connection between c2 and d3 - not navigable and therefore not element of the
    // result
    ...
    assertTrue("The Result of c2.getEigenNavigations() should be parti4",
        c2.getDefinedNavigations().contains(parti4)
            && !c2.getDefinedNavigations().contains(parti04));

    assertTrue("The Result of c2.getInheritedNavigations() should be parti2",
        c2.getInheritedNavigations().contains(parti2)
            && !c2.getInheritedNavigations().contains(parti01));
  ...
  // to do: getDomainMonikers(), getDomainForMoniker(EString) and
  // getAllNavigationsForMoniker(EString)
  // getAllNavigationsAsDestination(), getEigenNavigationsAsDestination(),
  // getInheritedNavigationsAsDestination - they depend on each other
  ...
  public void testRepresent() {
    ...
    // OCL expression aus Entity.represent(): if self.name.oclIsUndefined() then ''
  ...
  public void testGetFeatureForName() {
    ...
    // else self.getAllFeatures()->select(f|f.name = name)->asOrderedSet()->first()
    // endif

    // OCL expression for getAttributeByName():
    // let foundAttributes:OrderedSet(Attribute) = self.getAllAttributes()->select(a
    // | a.name = name)
    ...
    assertTrue("The result of person1.getFeatureForName(name) must be the attribute name",
        person1.getFeatureForName("name").equals(name));
    assertTrue("The result of person1.getAttributeByName(name) must be the attribute name",
        person1.getAttributeByName("name").equals(name));
    assertTrue("The result of person1.getFeatureForName(getName) must be the attribute name",
        person1.getFeatureForName("getName").equals(getName));
  }
  ...
  public void testGetPotencyAsString() {
    ...
    assertTrue("The result for c.getPotencyAsString() must be 11",
        c.getPotencyAsString().equals("11"));
  ...
  public void testViolatesMultiplicityConstraints() {
    ...
    assertTrue(
        "The result of c2.violatesMultiplicityConstraints() must state that it violates the multiplicity constraints",
    ...
    assertFalse(
        "The result of c2.violatesMultiplicityConstraints() must state that it doesn't violate the multiplicity constraints",
        c2.violatesMultiplicityConstraints());
