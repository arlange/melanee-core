...
public class CreateDeepModelTest {
	...
	public void test() {
		...
		/**********************************************
		 * Create first the domain which contains all
		 * Ontologies
		 **********************************************/
		...
		/**********************************************
		 * Create the ontology which contains the 
		 * ontological levels
		 **********************************************/
		...
		/**********************************************
		 * Create breed on the highest ontological 
		 * level
		 **********************************************/
		...
		/**********************************************
		 * Create an instance of collie which is a
		 * breed
		 **********************************************/
		...
		/**********************************************
		 * Create an abstract Dog which is supertype 
		 * of Collie
		 **********************************************/
		...
		/**********************************************
		 * Create a generalization between collie 
		 * and dog
		 **********************************************/
		...
		Resource resource = resourceSet.createResource(URI.createFileURI("c:\\w\\m\\manual.lml"));
		resource.getContents().add(domain);*/
		
		/**********************************************
		 * Create a GMF notation diagram package to 
		 * enable the GMF editor to render the diagram
		 **********************************************/
