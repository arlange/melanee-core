...
public class ClassificationTests {
	...
	public void testClassification() {
		...
		assertTrue("Direct double classification failed.", "OntC4:C3_2,C3".equals(designator) || "OntC4:C3,C3_2".equals(designator));
		
		designator = DesignationService.getInstance().evaluate(entities[4], "ontName:1::4");
		assertTrue("Direct double classification elision mix failed.", "OntC4:C3_2,C3::C0".equals(designator) || "OntC4:C3,C3_2::C0".equals(designator));
		
		designator = DesignationService.getInstance().evaluate(entities[4], "ontName:1:2");
		assertTrue("Direct double classification distance 2.", "OntC4:C3_2,C3:C2".equals(designator) || "OntC4:C3,C3_2:C2".equals(designator));
	}
}