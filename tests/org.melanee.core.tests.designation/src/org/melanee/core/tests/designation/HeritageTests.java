...
public class HeritageTests {
  ...
  public void testHeritage() {
    ...
    assertTrue("Direct double heritage failed.",
        "E3,E3_2>OntE4".equals(designator) || "E3_2,E3>OntE4".equals(designator));

    designator = DesignationService.getInstance().evaluate(entities[4], "4>>1>ontName");
    assertTrue("Direct double heritage elision mix failed.",
        "E0>>E3_2,E3>OntE4".equals(designator) || "E0>>E3,E3_2>OntE4".equals(designator));

    designator = DesignationService.getInstance().evaluate(entities[4], "2>1>ontName");
    assertTrue("Direct double heritage distance 2.",
        "E2>E3_2,E3>OntE4".equals(designator) || "E2>E3,E3_2>OntE4".equals(designator));
  }
