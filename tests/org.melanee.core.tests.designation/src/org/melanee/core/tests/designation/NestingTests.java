...
public class NestingTests {
  ...
  public void testNesting() {
    ...
    String designator = DesignationService.getInstance().evaluate(entities[3],
        "1(ontName).ontName");
    ...
    assertTrue("Direct heritage failed.",
        "(O0.OntE0).(E0.OntE1).(E1.OntE2).OntE3".equals(designator));
    ...
    // designator =
    // DesignationService.getInstance().evaluate("4(ontName)..1.ontName",
    // entities[3]);
    // assertTrue("Ellision mix model failed.",
    // "(O0)..(OntE2)..E2.OntE3".equals(designator));
    //
    // designator =
    // DesignationService.getInstance().evaluate("5(ontName)..1.ontName",
    // entities[3]);
    // assertTrue("Ellision mix deep model failed.",
    // "(Location_Test)..(OntE2)..E2.OntE3".equals(designator));
  }
