...
public class CreateNewLMLFileTest {
  ...
  public void canCreateLMLProject() {
    bot.menu(TestConstants.MENU_FILE).menu(TestConstants.MENU_NEW).menu(TestConstants.MENU_PROJECT)
        .click();
  ...
  public void createLMLFileInProject() {
    ...
    // Create a new file
    bot.menu(TestConstants.MENU_FILE).menu(TestConstants.MENU_NEW).menu(TestConstants.MENU_OTHER)
        .click();
    ...
    bot.viewByTitle(TestConstants.VIEW_PROJECT_EXPLORER_NAME).bot().tree()
        .expandNode(TestConstants.PROJECT_TEST_PROJECT_NAME, true)
        .select(TestConstants.FILE_TEST_FILE);
