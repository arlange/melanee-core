...
public class ModelDeepModelTest {
  ...
  public void openModel() {
    bot.viewByTitle(TestConstants.VIEW_PROJECT_EXPLORER_NAME).bot().tree()
        .expandNode(TestConstants.PROJECT_TEST_PROJECT_NAME).select(TestConstants.FILE_TEST_FILE)
  ...
  public void addTwoModelsViaPalette() {
    ...
    Point deepModelMiddle = GMFTestUtil
        .getEditPartCenter((IGraphicalEditPart) editor.getEditPart("Test Deep Model").part());
  ...
  public void addTypeEntities() {
    ...
    Point modelMiddle = GMFTestUtil
        .getEditPartCenter((IGraphicalEditPart) editor.getEditPart("O0").part());
  ...
  public void connectEntities() {
    ...
    try {
      ...
      setupRole.append(SetCommand.create(part.getEditingDomain(), r,
          PLMPackage.eINSTANCE.getConnectionEnd_Navigable(), false));
      setupRole.append(SetCommand.create(part.getEditingDomain(), r,
          PLMPackage.eINSTANCE.getConnectionEnd_Lower(), 1));
      setupRole.append(SetCommand.create(part.getEditingDomain(), r,
          PLMPackage.eINSTANCE.getConnectionEnd_Upper(), 1));
