 ...
 *******************************************************************************/
package org.melanee.core.melanee2metadepth.main;
...
/**
 * Entry point of the 'GenerateMetadepth' generation module.
 *
 * @generated
 */
public class GenerateMetadepth extends AbstractAcceleoGenerator {
  /**
   * The name of the module.
   *
   * @generated
   */
  public static final String MODULE_FILE_NAME = "/org/melanee/core/melanee2metadepth/main/generateMetadepth";
   ...
   * @generated
   */
  public static final String[] TEMPLATE_NAMES = { "generateDeepModel" };
   ...
   * @param targetFolder
   *          This will be used as the output folder for this generation : it will
   *          be the base path against which all file block URLs will be resolved.
   * @param arguments
   *          If the template which will be called requires more than one argument
   *          taken from the model, pass them here.
   * @throws IOException
   *           This can be thrown in three scenarios : the module cannot be found,
   *           it cannot be loaded, or the model cannot be loaded.
   * @generated
   */
  public GenerateMetadepth(URI modelURI, File targetFolder, List<? extends Object> arguments)
      throws IOException {
   ...
   * @generated
   */
  public GenerateMetadepth(EObject model, File targetFolder, List<? extends Object> arguments)
      throws IOException {
  ...
  public static void main(String[] args) {
    try {
      if (args.length < 2) {
        ...
        GenerateMetadepth generator = new GenerateMetadepth(modelURI, folder, arguments);
  ...
  public void registerResourceFactories(ResourceSet resourceSet) {
     ...
     * resource factory registration for UML.
     *
