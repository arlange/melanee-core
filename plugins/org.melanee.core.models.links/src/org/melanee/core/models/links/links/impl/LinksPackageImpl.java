...
public class LinksPackageImpl extends EPackageImpl implements LinksPackage {
   ...
   * 
   * <p>
   * This method is used to initialize {@link LinksPackage#eINSTANCE} when that
  ...
  public static LinksPackage init() {
    ...
    LinksPackageImpl theLinksPackage = (LinksPackageImpl) (EPackage.Registry.INSTANCE
        .get(eNS_URI) instanceof LinksPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
            : new LinksPackageImpl());
  ...
  public void initializePackageContents() {
    ...
    PLMPackage thePLMPackage = (PLMPackage) EPackage.Registry.INSTANCE
        .getEPackage(PLMPackage.eNS_URI);
    ...
    initEClass(linkingModelEClass, LinkingModel.class, "LinkingModel", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getLinkingModel_RemoteModels(), this.getRemoteModel(), null, "remoteModels",
        null, 0, -1, LinkingModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(remoteModelEClass, RemoteModel.class, "RemoteModel", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRemoteModel_Links(), this.getLink(), null, "links", null, 0, -1,
        RemoteModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRemoteModel_URL(), ecorePackage.getEString(), "URL", null, 0, 1,
        RemoteModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRemoteModel_Path(), ecorePackage.getEString(), "path", null, 0, 1,
        RemoteModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(linkEClass, Link.class, "Link", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getLink_Revision(), ecorePackage.getEString(), "revision", null, 0, 1,
        Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getLink_Target(), thePLMPackage.getElement(), null, "target", null, 1, 1,
        Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getLink_Source(), ecorePackage.getEString(), "source", null, 1, 1, Link.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    initEAttribute(getLink_SourceLocation(), ecorePackage.getEString(), "sourceLocation", null, 0,
        1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
