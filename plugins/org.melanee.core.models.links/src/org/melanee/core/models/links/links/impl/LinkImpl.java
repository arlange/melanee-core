 ...
 * </p>
 * <ul>
 *   <li>{@link org.melanee.core.models.links.links.impl.LinkImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link org.melanee.core.models.links.links.impl.LinkImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.melanee.core.models.links.links.impl.LinkImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.melanee.core.models.links.links.impl.LinkImpl#getSourceLocation <em>Source Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
	...
	public void setRevision(String newRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LinksPackage.LINK__REVISION, oldRevision, revision));
	}
	...
	public Element getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LinksPackage.LINK__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Element newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LinksPackage.LINK__TARGET, oldTarget, target));
	}
	...
	public void setSource(String newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LinksPackage.LINK__SOURCE, oldSource, source));
	}
	...
	public void setSourceLocation(String newSourceLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LinksPackage.LINK__SOURCE_LOCATION, oldSourceLocation, sourceLocation));
	}
