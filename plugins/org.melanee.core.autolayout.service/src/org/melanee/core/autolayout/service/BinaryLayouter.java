...
public class BinaryLayouter {
  ...
  public boolean matchesPattern(List<Rectangle> rectangles) {
    ...
    /*
     * R1 R2 _________ _________ | |_____| | |_________| |_________|
     */
     ...
     */
    if ((rect1.getTop().y > rect2.getBottom().y && rect1.getCenter().x > rect2.getBottomLeft().x
        && rect1.getCenter().x < rect2.getBottomRight().x)
        || (rect2.getTop().y > rect1.getBottom().y && rect2.getCenter().x > rect1.getBottomLeft().x
     ...
     */
    if ((rect1.getCenter().y > rect2.getCenter().y && rect1.getCenter().x < rect2.getCenter().x)
     ...
     */
    if ((rect1.getCenter().y > rect2.getCenter().y && rect1.getCenter().x > rect2.getCenter().x)
        || (rect2.getCenter().y > rect1.getCenter().y && rect2.getCenter().x > rect1.getCenter().x)
