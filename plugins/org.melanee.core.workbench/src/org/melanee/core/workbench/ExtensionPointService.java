...
public class ExtensionPointService {
  ...
  private void initialize() {
    ...
    configurationElements = Platform.getExtensionRegistry()
        .getConfigurationElementsFor(TEXTUAL_VISUALIZATION_SERVICE_ID);
    ...
    for (IConfigurationElement cElement : configurationElements)
      id2GraphicalVisualizationServiceConfigurationElement.put(cElement.getAttribute("id"),
          cElement);
    ...
    // Initialize the validation service
    configurationElements = Platform.getExtensionRegistry()
        .getConfigurationElementsFor(APPLICATION_VISUALIZATION_SERVICE_ID);

    for (IConfigurationElement cElement : configurationElements)
      id2IApplicationVisualizationServiceConfigurationElement.put(cElement.getAttribute("id"),
          cElement);
  }
  ...
  public IFormVisualizationService getFormVisualizationService(String id) throws CoreException {
    ...
    if (transformator == null) {
      ...
      transformator = (IFormVisualizationService) id2FormVisualizationServiceConfigurationElement
  ...
  public IFormVisualizationService getActiveFormVisualizationService() throws CoreException {
    ...
    return getFormVisualizationService(
        store.getString(PreferenceConstants.P_ACTIVE_FORM_VISUALIZATION_ENGINE));
  }
  ...
  public ITableVisualizationService getTableVisualizationService(String id) throws CoreException {
    ...
    if (transformator == null) {
      ...
      transformator = (ITableVisualizationService) id2TableVisualizationServiceConfigurationElement
          .get(id).createExecutableExtension("class");
  ...
  public ITableVisualizationService getActiveTableVisualizationService() throws CoreException {
    ...
    return getTableVisualizationService(
        store.getString(PreferenceConstants.P_ACTIVE_TABLE_VISUALIZATION_ENGINE));
  }
   ...
   * @throws CoreException
   */
  public ITextualVisualizationService getTextualVisualizationService(String id)
      throws CoreException {
  ...
  public ITextualVisualizationService getActiveTextualVisualizationService() throws CoreException {
    ...
    return getTextualVisualizationService(
        store.getString(PreferenceConstants.P_ACTIVE_TEXTUAL_VISUALIZATION_ENGINE));
  }
   ...
   * @throws CoreException
   */
  public IGraphicalVisualizationService getGraphicalVisualizationService(String id)
      throws CoreException {
   ...
   * @throws CoreException
   */
  public IGraphicalVisualizationService getActiveGraphicalVisualizationService()
      throws CoreException {
    IPreferenceStore store = Activator.getDefault().getPreferenceStore();

    return getGraphicalVisualizationService(
        store.getString(PreferenceConstants.P_ACTIVE_GRAPHICAL_VISUALIZATION_ENGINE));
  }
  ...
  public IReasoningService getReasoningService(String id) throws CoreException {
    ...
    if (reasoner == null && id2ReasoningServiceConfigurationElement.get(id) != null) {
      ...
      reasoner = (IReasoningService) id2ReasoningServiceConfigurationElement.get(id)
          .createExecutableExtension("class");
  ...
  public IEmendationService getEmendationService(String id) throws CoreException {
    ...
    if (emender == null) {
      ...
      emender = (IEmendationService) id2EmendationServiceConfigurationElement.get(id)
          .createExecutableExtension("class");
  ...
  public IDesignationService getDesignationService(String id) throws CoreException {
    ...
    if (designationService == null) {
      ...
      designationService = (IDesignationService) id2DesignationServiceConfigurationElement.get(id)
          .createExecutableExtension("class");
  ...
  public IDSLService getDSLService(String id) throws CoreException {
    ...
    if (dslService == null) {
      ...
      dslService = (IDSLService) id2DSLServiceConfigurationElement.get(id)
          .createExecutableExtension("class");
  ...
  public IPopupToolBarProvider getPopUpBarButtonProvider(String id) throws CoreException {
    ...
    if (popupBarToolProvider == null) {
      ...
      popupBarToolProvider = (IPopupToolBarProvider) id2IPopupToolBarProviderConfigurationElement
          .get(id).createExecutableExtension("class");
  ...
  public IValidationService getValidationService(String id) throws CoreException {
    ...
    if (validator == null) {
      ...
      validator = (IValidationService) id2IValidationServiceConfigurationElement.get(id)
          .createExecutableExtension("class");
  ...
  public IConstraintLanguageService getActiveConstraintLanguageService() throws CoreException {
    ...
    return getConstraintLanguageService(
        store.getString(PreferenceConstants.P_ACTIVE_CONSTRAINT_LANGUAGE_SERVICE));
  }
   ...
   * @throws CoreException
   */
  public IApplicationVisualizationService getActiveApplicationVisualizationService()
      throws CoreException {
    IPreferenceStore store = Activator.getDefault().getPreferenceStore();

    return getApplicationVisualizationService(
        store.getString(PreferenceConstants.P_ACTIVE_APPLICATION_VISUALIZATION_ENGINE));
  }
}
