...
public interface IDSLService {
  ...
  /**
   * Searches for all instantiable Connections between sourceInstance and
   * targetInstance
   * 
  ...
  /**
   * Searches for all instantiable connectionEnds between sourceInstance and
   * targetInstance
   * 
   * @param sourceInstance
   *          The source of the connectionEnd
   * @param targetInstance
   *          The target of the connectionEnd
   * 
   * @return A list of all instantiable connectionEnds
   */
