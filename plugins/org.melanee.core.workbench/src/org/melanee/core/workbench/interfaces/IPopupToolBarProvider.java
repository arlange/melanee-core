...
public interface IPopupToolBarProvider {
	...
	public class PopupToolBarToolWrapper{
		 ...
		 * @param tool the tool to execute (can be null)
		 * @param text the tooltip to display
		 * @param groupId the group to sort the drowp down into
		 */
	...
	public class PopupToolBarMenuWrapper extends PopupToolBarToolWrapper{
		...
		public PopupToolBarMenuWrapper(Object image, Object tool, String text, List<PopupToolBarToolWrapper> children, String groupId) {
