...
public interface IGraphicalVisualizationService extends IVisualizationServiceBase {
	 ...
	 * @param v graphical dsl visualizer to translate into a figure
	 * @param c the clabject meta-model element which is visualized
	 * @param compartmentFigure the figure which holds the content which
	 * 			owner by the model element, i.e. Clabject.content.
	 * 
	 * @return renderable figure (org.eclipse.draw2d.IFigure)
	 */
	 ...
	 * 
	 * @param v graphical dsl visualizer to translate into a figure
	 * @param p the connectionEnd meta-model element which is visualized
	 * @param figure the connectionEnd figure to manipulate
	 * 
	 * @return renderable figure (org.eclipse.draw2d.IFigure)
	 */
	 ...
	 * 
	 * @param constant value of Color Constant (org.melanee.graphdsl.models.definition.ColorConstant)
