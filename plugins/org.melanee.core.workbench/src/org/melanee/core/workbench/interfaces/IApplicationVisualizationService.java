...
public interface IApplicationVisualizationService extends IVisualizationServiceBase {
   ...
   * 
   * @param host
   *          the model-element on which to invoke the service (e.g.
   *          IGraphicalEditPart)
   * @param notation
   ...
   * 
   * <ol>
   * <li>Check the supertypes for a visualizer and take the closest with lowest
   * potency.</li>
   * <li>Check the types for a visualizer and take the closest with lowest
   * potency.</li>
   * <li>Return the default LMLVisualization (null)</li>
   * </ol>
   * 
   * @param e
   *          The element to search the DSLVisualizer for.
  ...
  /**
   * Retrievs the filter which manages the visibility of the ontological property
   * tab based on the active application dsl visualizers values.
   * 
  ...
  /**
   * Retrievs the filter which manages the visibility of the linguistic property
   * tab based on the active application dsl visualizers values.
   * 
  ...
  /**
   * Retrievs the filter which manages the visibility of the visualization
   * property tab based on the active application dsl visualizers values.
   * 
  ...
  /**
   * Retrievs the filter which manages the visibility of the multiplicity property
   * tab based on the active application dsl visualizers values.
   * 
   * @return the filter for visualization properties tab
   */
