...
public abstract interface IVisualizationServiceBase {
  ...
  /**
   * This method can be used to filter the visibility of the visualization editor
   * view.
   *
   * @param element
   *          Element to check visibility for
  ...
  /**
   * Needed to create the initial dsl initializer in VisualizationEditorView. Once
   * this is created, the rest can be inferred from the meta-model.
   * 
   ...
   * @paran mergeAspects determines if aspects are merged into the returned
   *        visualizer. If a visualizer which is not an aspect visualizer (a
   *        visualizer not containing aspects) is returned.
