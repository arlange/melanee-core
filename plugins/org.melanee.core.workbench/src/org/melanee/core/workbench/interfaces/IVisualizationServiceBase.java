...
public abstract interface IVisualizationServiceBase {
	...
	/**
	 * This method can be used to filter the visibility of the visualization
	 * editor view.
	 *
	 ...
	 * @paran mergeAspects determines if aspects are merged into the returned visualizer.
	 * 						If a visualizer which is not an aspect visualizer (a visualizer 
	 * 						not containing aspects) is returned.
	 * @return A graphical dsl visualizer or  null if none is found.
	 */
	public AbstractDSLVisualizer findDSLVisualizerForElement(Element e, String notation, boolean mergeAspects);
}
