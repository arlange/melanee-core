...
public class MelaneeWorkbenchPreferences extends FieldEditorPreferencePage
  ...
  public void createFieldEditors() {
    ...
    // Reasoning Service
    String[] reasoningEngineKeySet = ExtensionPointService.Instance()
        .getId2ReasoningServiceConfigurationElement().keySet().toArray(new String[] {});
    ...
    // Emendation Service
    String[] refactoringEngineKeySet = ExtensionPointService.Instance()
        .getId2EmendationServiceConfigurationElement().keySet().toArray(new String[] {});
    ...
    addField(new BooleanFieldEditor(PreferenceConstants.P_EMENDATION_ENGINE_ACTIVATED,
        "Emendation Service Activated", extensionPointGroup));

    // DSL Service
    String[] dslEngineKeySet = ExtensionPointService.Instance()
        .getId2DSLServiceConfigurationElement().keySet().toArray(new String[] {});
    ...
    String[] formVisualizationEngineKeySet = ExtensionPointService.Instance()
        .getId2FormVisualizationServiceConfigurationElement().keySet().toArray(new String[] {});
    ...
    String[] tableVisualizationEngineKeySet = ExtensionPointService.Instance()
        .getId2TableVisualizationServiceConfigurationElement().keySet().toArray(new String[] {});
    ...
    String[] proximityIndicationEngineKeySet = ExtensionPointService.Instance()
        .getId2DesignationServiceConfigurationElement().keySet().toArray(new String[] {});
    ...
    // Validation Service
    String[] validationEngineKeySet = ExtensionPointService.Instance()
        .getId2ValidationServiceConfigurationElement().keySet().toArray(new String[] {});
    ...
    String[] constraintLanguageEngineKeySet = ExtensionPointService.Instance()
        .getId2ContraintLanguageServiceConfigurationElement().keySet().toArray(new String[] {});
    ...
    warningLabel.setText(
        " After changing active extensions, it can be required to reset the Melanee perspective.");
