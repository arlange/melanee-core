...
public class MelaneePerspectiveFactory implements IPerspectiveFactory {
	...
	private void defineLayout(IPageLayout layout)
	{
        ...
        try {
        	IGraphicalVisualizationService graphicalVisualizationService = ExtensionPointService.Instance().getActiveGraphicalVisualizationService();
        	...
        	IFormVisualizationService formVisualizationService = ExtensionPointService.Instance().getActiveFormVisualizationService();
        	if (formVisualizationService != null)
        		visualizationViewsToOpen.add(formVisualizationService.getVisualizationEditorViewID());

        	ITextualVisualizationService textualVisualizationService = ExtensionPointService.Instance().getActiveTextualVisualizationService();
        	if (textualVisualizationService != null)
        		visualizationViewsToOpen.add(textualVisualizationService.getVisualizationEditorViewID());
        	
        	IApplicationVisualizationService applicationVisualizationService = ExtensionPointService.Instance().getActiveApplicationVisualizationService();
        	if (applicationVisualizationService != null)
        		visualizationViewsToOpen.add(applicationVisualizationService.getVisualizationEditorViewID());
