 ...
 * </p>
 * <ul>
 *   <li>{@link PLM.LMLVisualizer#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link PLM.LMLVisualizer#getDslVisualizer <em>Dsl Visualizer</em>}</li>
 *   <li>{@link PLM.LMLVisualizer#getName <em>Name</em>}</li>
 *   <li>{@link PLM.LMLVisualizer#getXLocation <em>XLocation</em>}</li>
 *   <li>{@link PLM.LMLVisualizer#getYLocation <em>YLocation</em>}</li>
 *   <li>{@link PLM.LMLVisualizer#getWidth <em>Width</em>}</li>
 *   <li>{@link PLM.LMLVisualizer#getHeight <em>Height</em>}</li>
 * </ul>
 *
 * @see PLM.PLMPackage#getLMLVisualizer()
 * @model
 * @generated
 */
public interface LMLVisualizer extends EObject {
   ...
   * @see PLM.PLMPackage#getLMLVisualizer_Attributes()
   * @model
   * @generated
   */
   ...
   * The list contents are of type {@link PLM.AbstractDSLVisualizer}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see PLM.PLMPackage#getLMLVisualizer_DslVisualizer()
   ...
   * @see #setName(String)
   * @see PLM.PLMPackage#getLMLVisualizer_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link PLM.LMLVisualizer#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see PLM.PLMPackage#getLMLVisualizer_XLocation()
   * @model default="-1"
   * @generated
   */
  int getXLocation();
  ...
  /**
   * Sets the value of the '{@link PLM.LMLVisualizer#getXLocation <em>XLocation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see PLM.PLMPackage#getLMLVisualizer_YLocation()
   * @model default="-1"
   * @generated
   */
  int getYLocation();
  ...
  /**
   * Sets the value of the '{@link PLM.LMLVisualizer#getYLocation <em>YLocation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setWidth(int)
   * @see PLM.PLMPackage#getLMLVisualizer_Width()
   * @model default="-1"
   * @generated
   */
  int getWidth();
  ...
  /**
   * Sets the value of the '{@link PLM.LMLVisualizer#getWidth <em>Width</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setHeight(int)
   * @see PLM.PLMPackage#getLMLVisualizer_Height()
   * @model default="-1"
   * @generated
   */
  int getHeight();
  ...
  /**
   * Sets the value of the '{@link PLM.LMLVisualizer#getHeight <em>Height</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
