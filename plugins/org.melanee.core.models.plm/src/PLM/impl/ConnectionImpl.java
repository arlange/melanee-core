 ...
 * </p>
 * <ul>
 *   <li>{@link PLM.impl.ConnectionImpl#getConnectionEnd <em>Connection End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionImpl extends ClabjectImpl implements Connection {
  ...
  /**
   * The cached invocation delegate for the '{@link #getDomain(PLM.Clabject) <em>Get Domain</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getDomain(PLM.Clabject)
   * @generated
   * @ordered
   */
  ...
  /**
   * The cached invocation delegate for the '{@link #getMonikerForParticipant(PLM.Clabject) <em>Get Moniker For Participant</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getMonikerForParticipant(PLM.Clabject)
   * @generated
   * @ordered
   */
