 ...
 * </p>
 * <ul>
 *   <li>{@link PLM.impl.ConnectionEndImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link PLM.impl.ConnectionEndImpl#getUpper <em>Upper</em>}</li>
 *   <li>{@link PLM.impl.ConnectionEndImpl#isNavigable <em>Navigable</em>}</li>
 *   <li>{@link PLM.impl.ConnectionEndImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link PLM.impl.ConnectionEndImpl#getConnection <em>Connection</em>}</li>
 *   <li>{@link PLM.impl.ConnectionEndImpl#getMoniker <em>Moniker</em>}</li>
 *   <li>{@link PLM.impl.ConnectionEndImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link PLM.impl.ConnectionEndImpl#getType <em>Type</em>}</li>
 *   <li>{@link PLM.impl.ConnectionEndImpl#getMultiplicity <em>Multiplicity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionEndImpl extends PropertyImpl implements ConnectionEnd {
  ...
  /**
   * The cached invocation delegate for the '{@link #hasDefaultMoniker() <em>Has Default Moniker</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The cached invocation delegate for the '{@link #conforms(PLM.ConnectionEnd) <em>Conforms</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #conforms(PLM.ConnectionEnd)
   * @generated
   * @ordered
   */
