 ...
 * </p>
 * <ul>
 *   <li>{@link PLM.Inheritance#getSupertype <em>Supertype</em>}</li>
 *   <li>{@link PLM.Inheritance#getSubtype <em>Subtype</em>}</li>
 *   <li>{@link PLM.Inheritance#getDisjoint <em>Disjoint</em>}</li>
 *   <li>{@link PLM.Inheritance#getComplete <em>Complete</em>}</li>
 * </ul>
 *
 * @see PLM.PLMPackage#getInheritance()
 * @model
 * @generated
 */
public interface Inheritance extends Correlation {
   ...
   * The list contents are of type {@link PLM.Supertype}.
   * It is bidirectional and its opposite is '{@link PLM.Supertype#getInheritance <em>Inheritance</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see PLM.PLMPackage#getInheritance_Supertype()
   ...
   * The list contents are of type {@link PLM.Subtype}.
   * It is bidirectional and its opposite is '{@link PLM.Subtype#getInheritance <em>Inheritance</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see PLM.PLMPackage#getInheritance_Subtype()
   ...
   * @see PLM.PLMPackage#getInheritance_Disjoint()
   * @model
   * @generated
   */
  Boolean getDisjoint();
  ...
  /**
   * Sets the value of the '{@link PLM.Inheritance#getDisjoint <em>Disjoint</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see PLM.PLMPackage#getInheritance_Complete()
   * @model
   * @generated
   */
  Boolean getComplete();
  ...
  /**
   * Sets the value of the '{@link PLM.Inheritance#getComplete <em>Complete</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL body='not (self.disjoint.oclIsUndefined() or self.disjoint = false)'"
   * @generated
   */
  boolean isDisjoint();
   ...
   * <!-- end-model-doc -->
   * @model kind="operation" required="true" ordered="false"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL body='not (self.complete.oclIsUndefined() or self.complete = false)'"
   * @generated
   */
  boolean isComplete();
   ...
   * <!-- end-model-doc -->
   * @model kind="operation" required="true" ordered="false"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL body='(not (self.intersection.oclIsUndefined() or self.intersection = false))'"
   * @generated
   */
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * returns a human readable string representation of the generalization. If the name is set, the name is returned.
