...
public interface Classification extends Correlation {
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Instance</em>' reference isn't clear, there really
   ...
   * is <code>"instantiation"</code>. The literals are from the enumeration
   * {@link org.melanee.core.models.plm.PLM.ClassificationKind}. <!--
   * begin-user-doc -->
   * <p>
   ...
   * returns a human readable representation of the classification constructed
   * from the names of the instance and the type as well as the kind of the
   * classification. <!-- end-model-doc -->
   * 
