 ...
 * </p>
 * <ul>
 * <li>{@link org.melanee.core.models.plm.PLM.impl.SupertypeImpl#getSupertype
 * <em>Supertype</em>}</li>
 * <li>{@link org.melanee.core.models.plm.PLM.impl.SupertypeImpl#getInheritance
...
public class SupertypeImpl extends MinimalEObjectImpl.Container implements Supertype {
    ...
    if (supertype != null && supertype.eIsProxy()) {
      ...
      if (supertype != oldSupertype) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PLMPackage.SUPERTYPE__SUPERTYPE,
  ...
  public void setSupertype(Clabject newSupertype) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.SUPERTYPE__SUPERTYPE,
          oldSupertype, supertype));
  }
  ...
  public Inheritance getInheritance() {
    if (eContainerFeatureID() != PLMPackage.SUPERTYPE__INHERITANCE)
      return null;
  ...
  public NotificationChain basicSetInheritance(Inheritance newInheritance, NotificationChain msgs) {
    msgs = eBasicSetContainer((InternalEObject) newInheritance, PLMPackage.SUPERTYPE__INHERITANCE,
        msgs);
    return msgs;
  }
  ...
  public void setInheritance(Inheritance newInheritance) {
    if (newInheritance != eInternalContainer()
        || (eContainerFeatureID() != PLMPackage.SUPERTYPE__INHERITANCE && newInheritance != null)) {
      ...
      if (newInheritance != null)
        msgs = ((InternalEObject) newInheritance).eInverseAdd(this,
            PLMPackage.INHERITANCE__SUPERTYPE, Inheritance.class, msgs);
      msgs = basicSetInheritance(newInheritance, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.SUPERTYPE__INHERITANCE,
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
    ...
    case PLMPackage.SUPERTYPE__INHERITANCE:
      return eInternalContainer().eInverseRemove(this, PLMPackage.INHERITANCE__SUPERTYPE,
