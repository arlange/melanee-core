 ...
 * </p>
 * <ul>
 * <li>{@link org.melanee.core.models.plm.PLM.impl.InheritanceImpl#getSupertype
 * <em>Supertype</em>}</li>
 * <li>{@link org.melanee.core.models.plm.PLM.impl.InheritanceImpl#getSubtype
 * <em>Subtype</em>}</li>
 * <li>{@link org.melanee.core.models.plm.PLM.impl.InheritanceImpl#getDisjoint
 * <em>Disjoint</em>}</li>
 * <li>{@link org.melanee.core.models.plm.PLM.impl.InheritanceImpl#getComplete
 * <em>Complete</em>}</li>
 * </ul>
 *
 * @generated
...
public class InheritanceImpl extends CorrelationImpl implements Inheritance {
  /**
   * The cached value of the '{@link #getSupertype() <em>Supertype</em>}'
  ...
  /**
   * The cached value of the '{@link #getSubtype() <em>Subtype</em>}' containment
  ...
  /**
   * The default value of the '{@link #getDisjoint() <em>Disjoint</em>}'
  ...
  /**
   * The default value of the '{@link #getComplete() <em>Complete</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getComplete()
   * @generated
  ...
  public EList<Supertype> getSupertype() {
    if (supertype == null) {
      supertype = new EObjectContainmentWithInverseEList<Supertype>(Supertype.class, this,
          PLMPackage.INHERITANCE__SUPERTYPE, PLMPackage.SUPERTYPE__INHERITANCE);
    }
    return supertype;
  }
  ...
  public EList<Subtype> getSubtype() {
    if (subtype == null) {
      subtype = new EObjectContainmentWithInverseEList<Subtype>(Subtype.class, this,
          PLMPackage.INHERITANCE__SUBTYPE, PLMPackage.SUBTYPE__INHERITANCE);
    }
    return subtype;
  }
  ...
  public void setDisjoint(Boolean newDisjoint) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.INHERITANCE__DISJOINT,
          oldDisjoint, disjoint));
  }
  ...
  public void setComplete(Boolean newComplete) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.INHERITANCE__COMPLETE,
          oldComplete, complete));
  }

  /**
   * The cached invocation delegate for the '{@link #isDisjoint() <em>Is
   ...
   * @ordered
   */
  protected static final EOperation.Internal.InvocationDelegate IS_DISJOINT__EINVOCATION_DELEGATE = ((EOperation.Internal) PLMPackage.Literals.INHERITANCE___IS_DISJOINT)
  ...
  /**
   * The cached invocation delegate for the '{@link #isComplete() <em>Is
   ...
   * @ordered
   */
  protected static final EOperation.Internal.InvocationDelegate IS_COMPLETE__EINVOCATION_DELEGATE = ((EOperation.Internal) PLMPackage.Literals.INHERITANCE___IS_COMPLETE)
      .getInvocationDelegate();
  ...
  /**
   * The cached invocation delegate for the '{@link #isIntersection() <em>Is
   ...
   * @ordered
   */
  protected static final EOperation.Internal.InvocationDelegate IS_INTERSECTION__EINVOCATION_DELEGATE = ((EOperation.Internal) PLMPackage.Literals.INHERITANCE___IS_INTERSECTION)
      .getInvocationDelegate();
   ...
   * @ordered
   */
  protected static final EOperation.Internal.InvocationDelegate REPRESENT__EINVOCATION_DELEGATE = ((EOperation.Internal) PLMPackage.Literals.INHERITANCE___REPRESENT)
      .getInvocationDelegate();
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
    ...
    case PLMPackage.INHERITANCE__SUPERTYPE:
      return ((InternalEList<InternalEObject>) (InternalEList<?>) getSupertype()).basicAdd(otherEnd,
          msgs);
    case PLMPackage.INHERITANCE__SUBTYPE:
      return ((InternalEList<InternalEObject>) (InternalEList<?>) getSubtype()).basicAdd(otherEnd,
          msgs);
    }
