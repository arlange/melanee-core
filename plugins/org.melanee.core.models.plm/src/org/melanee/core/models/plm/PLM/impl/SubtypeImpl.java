 ...
 * </p>
 * <ul>
 * <li>{@link org.melanee.core.models.plm.PLM.impl.SubtypeImpl#getSubtype
 * <em>Subtype</em>}</li>
 * <li>{@link org.melanee.core.models.plm.PLM.impl.SubtypeImpl#getInheritance
...
public class SubtypeImpl extends MinimalEObjectImpl.Container implements Subtype {
    ...
    if (subtype != null && subtype.eIsProxy()) {
      ...
      if (subtype != oldSubtype) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PLMPackage.SUBTYPE__SUBTYPE,
              oldSubtype, subtype));
      }
    }
    return subtype;
  ...
  public void setSubtype(Clabject newSubtype) {
    ...
    subtype = newSubtype;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.SUBTYPE__SUBTYPE, oldSubtype,
          subtype));
  }
  ...
  public Inheritance getInheritance() {
    if (eContainerFeatureID() != PLMPackage.SUBTYPE__INHERITANCE)
      return null;
  ...
  public NotificationChain basicSetInheritance(Inheritance newInheritance, NotificationChain msgs) {
    msgs = eBasicSetContainer((InternalEObject) newInheritance, PLMPackage.SUBTYPE__INHERITANCE,
        msgs);
    return msgs;
  }
  ...
  public void setInheritance(Inheritance newInheritance) {
    if (newInheritance != eInternalContainer()
        || (eContainerFeatureID() != PLMPackage.SUBTYPE__INHERITANCE && newInheritance != null)) {
      ...
      if (newInheritance != null)
        msgs = ((InternalEObject) newInheritance).eInverseAdd(this, PLMPackage.INHERITANCE__SUBTYPE,
            Inheritance.class, msgs);
      msgs = basicSetInheritance(newInheritance, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PLMPackage.SUBTYPE__INHERITANCE,
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
    ...
    case PLMPackage.SUBTYPE__INHERITANCE:
      return eInternalContainer().eInverseRemove(this, PLMPackage.INHERITANCE__SUBTYPE,
          Inheritance.class, msgs);
    }
