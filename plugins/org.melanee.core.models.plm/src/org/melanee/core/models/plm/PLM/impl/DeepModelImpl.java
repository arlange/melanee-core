...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Deep
...
public class DeepModelImpl extends ElementImpl implements DeepModel {
  ...
  /**
   * The cached invocation delegate for the '{@link #getLevelAtIndex(int) <em>Get
   * Level At Index</em>}' operation. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
