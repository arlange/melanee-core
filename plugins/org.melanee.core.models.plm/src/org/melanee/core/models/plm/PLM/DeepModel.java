...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Deep
 ...
 * </p>
 * <ul>
 * <li>{@link org.melanee.core.models.plm.PLM.DeepModel#getContent
 * <em>Content</em>}</li>
 * <li>{@link org.melanee.core.models.plm.PLM.DeepModel#getEnumeration
...
public interface DeepModel extends Element {
   ...
   * {@link org.melanee.core.models.plm.PLM.Level}. <!-- begin-user-doc -->
   * <p>
   ...
   * list. The list contents are of type
   * {@link org.melanee.core.models.plm.PLM.Enumeration}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Enumeration</em>' containment reference list isn't
   * clear, there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * returns the model identified by the level <!-- end-model-doc -->
   * 
   * @model ordered="false" levelRequired="true"
   *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL body='if level >
   *        0 and level <= self.content->size()
  ...
  /**
   * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
   * returns all primitive datatypes <!-- end-model-doc -->
   * 
   ...
   *        (self.oclAsType(ecore::EObject).eClass().ePackage.getEAnnotation(\'http://melanee.org/PLM/Datatypes\').details->select(e
   *        | e.key = type)->size() = 1)
   *        then\r\n\tself.oclAsType(ecore::EObject).eClass().ePackage.getEAnnotation(\'http://melanee.org/PLM/Datatypes\').details->select(e
   *        | e.key = type).value->first()\r\nelse\r\n\tnull\r\nendif'"
   * @generated
   */
  ...
  /**
   * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
   * returns all primitive datatypes and enumeration <!-- end-model-doc -->
   * 
   * @model kind="operation" annotation="http://www.eclipse.org/emf/2002/Ecore/OCL
