...
/**
 * Interface used for configuring the
 * {@link AspectAwareVisualizationSearchAlgorithm}.
 */
public interface IAspectAwareVisualizationSearchAlgorithmHelper {

  /**
   * Checks if the current visualizer is of the right type e.g. when searching for
   * a graphical dsl visualizer, all textual one shall be ignored. The
   * implementation is usually an instance of check.
   * 
   * @param visualizer
   *          the visualizer to check
   ...
   * @param obj
   *          EObject to test.
   * @return true => obj is treated as aspect; false => obj is not treated as
   *         aspect
   */
   ...
   * 
   * @param aspect
   *          The aspect to get the visualizer for.
   * @return
   */
  public EObject getAspectContainingClabject(EObject aspect);

  /**
   * Retrieves the condition of the aspect. The visualizer is only applied if the
   * condition is true.
   * 
   * @param aspect
   *          The obj containing the condition.
   ...
   * join point if both names match. If eObj is neither an aspect nor an joinpoint
   * null is expected as result.
   * 
   * @param eObj
   *          The aspect to get the name for
   * @return
   */
   ...
   * 
   * <b>Do not create any copy of the parameters. All copies and the resolution to
   * their origin is handled by the visualization search algorithm.</b>
   * 
   * @param aspect
   *          a copy of the aspect
   * @param joinPoint
  ...
  /**
   * Checks whether the dslVisualizer is defined for the notation which is to be
   * applied
   * 
   * @param dslVisualizer
   *          AbstractDSLVisualizer to check
