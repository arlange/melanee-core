...
import org.melanee.core.modeleditor.edit.policies.ConnectionConnectionContentsCompartmentCanonicalEditPolicy;
import org.melanee.core.modeleditor.edit.policies.ConnectionConnectionContentsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ConnectionConnectionContentsCompartmentEditPart extends ShapeCompartmentEditPart {
   ...
   * @generated
   */
  public ConnectionConnectionContentsCompartmentEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new ConnectionConnectionContentsCompartmentItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.CREATION_ROLE,
        new CreationEditPolicyWithCustomReparent(PLMVisualIDRegistry.TYPED_INSTANCE));
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
        new ConnectionConnectionContentsCompartmentCanonicalEditPolicy());
