 ...
 * @generated
 */
public class ConnectionConnectionMethodsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionMethodsCompartment_7055SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return MethodEditPart.VISUAL_ID == PLMVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionMethodsCompartment_7055SemanticChildren((View) getHost().getModel());
