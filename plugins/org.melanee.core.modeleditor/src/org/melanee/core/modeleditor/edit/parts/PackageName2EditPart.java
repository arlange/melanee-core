...
public class PackageName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public static final int VISUAL_ID = 5352;
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Package_3129, getParserElement(), PLMVisualIDRegistry
					.getType(org.melanee.core.modeleditor.edit.parts.PackageName2EditPart.VISUAL_ID));
		}
		return parser;
	}
