 ...
 * @generated
 */
public class ConnectionNameExternalLabelEditPart extends LabelEditPart
  ...
  static {
    registerSnapBackPosition(
        PLMVisualIDRegistry.getType(
            org.melanee.core.modeleditor.edit.parts.ConnectionNameExternalLabelEditPart.VISUAL_ID),
        new Point(0, 0));
  }
   ...
   * @generated
   */
  public ConnectionNameExternalLabelEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = PLMParserProvider.getParser(PLMElementTypes.Entity_3105, getParserElement(),
