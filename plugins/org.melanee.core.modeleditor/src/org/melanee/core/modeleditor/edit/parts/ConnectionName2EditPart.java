 ...
 * @generated
 */
public class ConnectionName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PLMVisualIDRegistry.getType(org.melanee.core.modeleditor.edit.parts.ConnectionName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ConnectionName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Connection_3111, getParserElement(),
					PLMVisualIDRegistry
							.getType(org.melanee.core.modeleditor.edit.parts.ConnectionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ConnectionNameExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConnectionNameExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureConnectionNameExternalFigure;
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureConnectionNameExternalFigure() {
