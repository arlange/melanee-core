 ...
 * @generated
 */
public class EntityEntityAttributesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityAttributesCompartment_7058SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityAttributesCompartment_7058SemanticChildren((View) getHost().getModel());
