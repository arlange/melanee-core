 ...
 * @generated
 */
public class DeepModelDeepModelLevelCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PLMPackage.eINSTANCE.getDeepModel_Content();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getDeepModelDeepModelLevelCompartment_7062SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return LevelEditPart.VISUAL_ID == PLMVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getDeepModelDeepModelLevelCompartment_7062SemanticChildren((View) getHost().getModel());
