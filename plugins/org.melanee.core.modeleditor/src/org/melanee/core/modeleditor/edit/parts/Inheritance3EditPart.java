...
import org.melanee.core.modeleditor.edit.policies.Inheritance3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Inheritance3EditPart extends AbstractBorderedShapeEditPart {
   ...
   * @generated
   */
  public Inheritance3EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Inheritance3ItemSemanticEditPolicy());
    ...
    installEditPolicy(SelectionEditPolicy.SELECTION_FEEDBACK_ROLE,
        new ExtendableToolbarSelectionEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof InheritanceName5EditPart) {
      ((InheritanceName5EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureGeneralisationNameFigure());
      return true;
    }
  ...
  protected void addBorderItem(IFigure borderItemContainer,
    ...
    if (borderItemEditPart instanceof InheritanceName6EditPart) {
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(PLMVisualIDRegistry.getType(InheritanceName5EditPart.VISUAL_ID));
  }
  ...
  public class GeneralizationFigure extends ScalablePolygonShape {
    ...
    private void createContents() {
      ...
      nameRectangle0.add(fFigureGeneralisationNameFigure,
          constraintFFigureGeneralisationNameFigure);
      ...
      nameRectangle0.add(fFigureGeneralisationSubtitleFigure,
          constraintFFigureGeneralisationSubtitleFigure);
