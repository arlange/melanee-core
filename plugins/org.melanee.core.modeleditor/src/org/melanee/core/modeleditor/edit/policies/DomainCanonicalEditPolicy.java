...
public class DomainCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater.getDomain_1000SemanticChildren(viewObject);
	...
	*/
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<PLMLinkDescriptor> linkDescriptors = collectAllLinks(getDiagram(), domain2NotationMap);
	...
	* @generated
	*/
	private Collection<PLMLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
	...
	*/
	protected final EditPart getHintedEditPart(EObject domainModelElement, Domain2Notation domain2NotationMap,
			int hintVisualId) {
		View view = (View) domain2NotationMap.getHinted(domainModelElement, PLMVisualIDRegistry.getType(hintVisualId));
		if (view != null) {
			return (EditPart) getHost().getViewer().getEditPartRegistry().get(view);
		}
		return null;
