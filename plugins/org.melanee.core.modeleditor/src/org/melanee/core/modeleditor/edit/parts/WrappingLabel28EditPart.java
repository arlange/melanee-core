 ...
 * @generated
 */
public class WrappingLabel28EditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 5282;
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = PLMParserProvider.getParser(PLMElementTypes.Connection_3111, getParserElement(),
          PLMVisualIDRegistry
              .getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel28EditPart.VISUAL_ID));
    }
    return parser;
  }
