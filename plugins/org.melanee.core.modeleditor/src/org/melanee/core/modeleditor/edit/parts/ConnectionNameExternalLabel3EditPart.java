 ...
 * @generated
 */
public class ConnectionNameExternalLabel3EditPart extends LabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 5342;
	...
	static {
		registerSnapBackPosition(
				PLMVisualIDRegistry.getType(
						org.melanee.core.modeleditor.edit.parts.ConnectionNameExternalLabel3EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ConnectionNameExternalLabel3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Entity_3126, getParserElement(),
