...
public class Method2CreateCommand extends EditElementCommand {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    Method newElement = PLMFactory.eINSTANCE.createMethod();

    Clabject owner = (Clabject) getElementToEdit();
    owner.getFeature().add(newElement);

    ElementInitializers.getInstance().init_Method_3108(newElement);
   ...
   * @generated
   */
  protected void doConfigure(Method newElement, IProgressMonitor monitor, IAdaptable info)
      throws ExecutionException {
