...
public class ConnectionEndEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
  ...
  public class ConnectionParticipationFigure extends PolylineConnectionEx {
    ...
    private void createContents() {
      ...
      fFigureConnectionParticipationNameFigure
          .setFont(FFIGURECONNECTIONPARTICIPATIONNAMEFIGURE_FONT);
   ...
   * @generated
   */
  static final Font FFIGURECONNECTIONPARTICIPATIONMULTIPLICITYFIGURE_FONT = new Font(
      Display.getCurrent(), Display.getDefault().getSystemFont().getFontData()[0].getName(), 8,
      SWT.NORMAL);
  ...
  public void updateView(String format) {
    ...
    connectionFigure.getChildren()
        .retainAll(Arrays.asList(
            new Object[] { connectionFigure.getFigureConnectionParticipationMultiplicityFigure(),
    ...
    // performRequest(new
    // org.eclipse.gef.Request(org.eclipse.gmf.runtime.diagram.ui.requests.RequestConstants.REQ_REFRESH));
  }
  ...
  private void updateLMLRenderingView() {
    ...
    // Is navigable
    // *****************************************************************
    if (self.getKind() == ConnectionEndKind.COMPOSITION
        || self.getKind() == ConnectionEndKind.AGGREGATION) {
  ...
  // {
  // org.melanee.core.models.plm.PLM.ConnectionEnd self =
  // (org.melanee.core.models.plm.PLM.ConnectionEnd) resolveSemanticElement();
  // org.melanee.core.models.plm.PLM.Connection c =
  // (org.melanee.core.models.plm.PLM.Connection)self.eContainer();
  //
   ...
   * @generated
   */
  private AbstractDSLVisualizer getConnectionDSLVisualizer(
      IGraphicalVisualizationService transformator, String notation) {
