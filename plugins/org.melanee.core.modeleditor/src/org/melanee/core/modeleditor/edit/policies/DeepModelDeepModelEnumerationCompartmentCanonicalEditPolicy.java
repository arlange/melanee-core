 ...
 * @generated
 */
public class DeepModelDeepModelEnumerationCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PLMPackage.eINSTANCE.getDeepModel_Enumeration();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getDeepModelDeepModelEnumerationCompartment_7061SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return EnumerationEditPart.VISUAL_ID == PLMVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getDeepModelDeepModelEnumerationCompartment_7061SemanticChildren((View) getHost().getModel());
