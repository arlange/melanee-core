 ...
 * @generated
 */
public class WrappingLabel48EditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 5347;
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = PLMParserProvider.getParser(PLMElementTypes.Connection_3127, getParserElement(),
          PLMVisualIDRegistry
              .getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel48EditPart.VISUAL_ID));
    }
    return parser;
  }
