 ...
 * @generated
 */
public class InheritanceName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 5326;
	...
	* @generated
	*/
	public InheritanceName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Inheritance_3122, getParserElement(),
					PLMVisualIDRegistry
							.getType(org.melanee.core.modeleditor.edit.parts.InheritanceName3EditPart.VISUAL_ID));
		}
		return parser;
	}
