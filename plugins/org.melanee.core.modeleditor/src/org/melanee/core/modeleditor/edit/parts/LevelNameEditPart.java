 ...
 * @generated
 */
public class LevelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 5320;
	...
	* @generated
	*/
	public LevelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Level_3097, getParserElement(),
					PLMVisualIDRegistry.getType(org.melanee.core.modeleditor.edit.parts.LevelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
