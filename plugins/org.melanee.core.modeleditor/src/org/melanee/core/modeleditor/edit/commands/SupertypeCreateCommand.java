 ...
 * @generated
 */
public class SupertypeCreateCommand extends EditElementCommand {
   ...
   * @generated
   */
  public SupertypeCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
  ...
  public boolean canExecute() {
    ...
    return PLMBaseItemSemanticEditPolicy.getLinkConstraints()
        .canCreateSupertype_4034(getContainer(), getSource(), getTarget());
  }
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    Supertype newElement = PLMFactory.eINSTANCE.createSupertype();
    getContainer().getSupertype().add(newElement);
    newElement.setInheritance(getSource());
    newElement.setSupertype(getTarget());
   ...
   * @generated
   */
  protected void doConfigure(Supertype newElement, IProgressMonitor monitor, IAdaptable info)
      throws ExecutionException {
