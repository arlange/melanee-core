 ...
 * @generated
 */
public class Connection2CreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public Connection2CreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    ElementInitializers.getInstance().init_Connection_3111(newElement);
