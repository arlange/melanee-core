...
import org.melanee.core.modeleditor.edit.policies.ConnectionConnectionContentsCompartment2CanonicalEditPolicy;
import org.melanee.core.modeleditor.edit.policies.ConnectionConnectionContentsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ConnectionConnectionContentsCompartment2EditPart extends ShapeCompartmentEditPart {
   ...
   * @generated
   */
  public ConnectionConnectionContentsCompartment2EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new ConnectionConnectionContentsCompartment2ItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.CREATION_ROLE,
        new CreationEditPolicyWithCustomReparent(PLMVisualIDRegistry.TYPED_INSTANCE));
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
        new ConnectionConnectionContentsCompartment2CanonicalEditPolicy());
  ...
  /**
   * Saves the location to the _request for later synchronization with the
   * LMLVisualizer in the CreatCommand.
   */
  @Override
