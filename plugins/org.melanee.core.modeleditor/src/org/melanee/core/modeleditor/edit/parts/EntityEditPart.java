...
import org.melanee.core.modeleditor.edit.policies.EntityItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EntityEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel16EditPart) {
			((WrappingLabel16EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityNameFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel17EditPart) {
			((WrappingLabel17EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityPotencyLabel());
			return true;
		}
		if (childEditPart instanceof WrappingLabel18EditPart) {
			((WrappingLabel18EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityLevelFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel19EditPart) {
			((WrappingLabel19EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityAVSFigure());
			return true;
		}
		...
		if (childEditPart instanceof EntityEntityAttributesCompartmentEditPart) {
			...
			pane.add(((EntityEntityAttributesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EntityEntityMethodsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureMethodsCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EntityEntityMethodsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EntityEntityContentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureContentCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EntityEntityContentsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EntityEntityAttributesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureAttributesCompartmentRectangle();
			pane.remove(((EntityEntityAttributesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EntityEntityMethodsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureMethodsCompartmentRectangle();
			pane.remove(((EntityEntityMethodsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof EntityEntityContentsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureContentCompartmentRectangle();
			pane.remove(((EntityEntityContentsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof EntityEntityMethodsCompartmentEditPart) {
			return getPrimaryShape().getFigureMethodsCompartmentRectangle();
		}
		if (editPart instanceof EntityEntityContentsCompartmentEditPart) {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ConnectionNameExternalLabelEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PLMVisualIDRegistry.getType(WrappingLabel16EditPart.VISUAL_ID));
	}
				...
				for (Clabject instance : changedEntity.getInstances()) {
					...
					if (featureEditParts.size() > 0) {
						...
						if (featureEditPart instanceof org.melanee.core.modeleditor.edit.parts.EntityEditPart)
							((org.melanee.core.modeleditor.edit.parts.EntityEditPart) featureEditPart)
									.updateView(IVisualizationServiceBase.FORMAT_GRAPH);
	...
	private void updateNameCompartment() {
		try {
			...
			WrappingLabel classificationDesignationWrappingLabel =
					...
					((org.melanee.core.modeleditor.edit.parts.EntityEditPart.EntityFigure) getPrimaryShape())
		...
		public void notifyChanged(Notification notification) {
			...
			for (Clabject i : instances) {
				...
				if (ep instanceof org.melanee.core.modeleditor.edit.parts.EntityEditPart)
					((org.melanee.core.modeleditor.edit.parts.EntityEditPart) ep)
							.updateView(IVisualizationServiceBase.FORMAT_GRAPH);
