...
import org.melanee.core.modeleditor.edit.policies.InheritanceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InheritanceEditPart extends AbstractBorderedShapeEditPart {
   ...
   * @generated
   */
  public InheritanceEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InheritanceItemSemanticEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof InheritanceNameEditPart) {
      ((InheritanceNameEditPart) childEditPart)
  ...
  protected void addBorderItem(IFigure borderItemContainer,
    ...
    if (borderItemEditPart instanceof InheritanceName2EditPart) {
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(PLMVisualIDRegistry.getType(InheritanceNameEditPart.VISUAL_ID));
  }
