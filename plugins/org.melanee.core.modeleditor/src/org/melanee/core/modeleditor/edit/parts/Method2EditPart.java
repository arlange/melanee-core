	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WrappingLabel25EditPart) {
			((WrappingLabel25EditPart) childEditPart).setLabel(getPrimaryShape().getFigureMethodInputFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel26EditPart) {
			((WrappingLabel26EditPart) childEditPart).setLabel(getPrimaryShape().getFigureMethodPotencyFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel27EditPart) {
			((WrappingLabel27EditPart) childEditPart).setLabel(getPrimaryShape().getFigureMethodOutputFigure());
			return true;
		}
		return false;
	}
