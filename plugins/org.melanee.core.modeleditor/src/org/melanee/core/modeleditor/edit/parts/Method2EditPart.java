...
import org.melanee.core.modeleditor.edit.policies.Method2ItemSemanticEditPolicy;
...
public class Method2EditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof MethodName2EditPart) {
      ((MethodName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureMethodNameFigure());
      return true;
    }
    if (childEditPart instanceof WrappingLabel25EditPart) {
      ((WrappingLabel25EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureMethodInputFigure());
      return true;
    }
    if (childEditPart instanceof WrappingLabel26EditPart) {
      ((WrappingLabel26EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureMethodPotencyFigure());
      return true;
    }
    if (childEditPart instanceof WrappingLabel27EditPart) {
      ((WrappingLabel27EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureMethodOutputFigure());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(PLMVisualIDRegistry.getType(MethodName2EditPart.VISUAL_ID));
  }
  ...
  public class MethodFigure extends RectangleFigure {
    ...
    private void createContents() {
      ...
      fFigureMethodPotencyFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(0),
