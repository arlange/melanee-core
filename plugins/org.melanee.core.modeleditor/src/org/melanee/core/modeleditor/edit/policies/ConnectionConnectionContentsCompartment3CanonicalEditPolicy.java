 ...
 * @generated
 */
public class ConnectionConnectionContentsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionContentsCompartment_7069SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionContentsCompartment_7069SemanticChildren((View) getHost().getModel());
