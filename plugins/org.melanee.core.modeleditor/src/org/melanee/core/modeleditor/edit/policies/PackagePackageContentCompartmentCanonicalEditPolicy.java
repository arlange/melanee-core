 ...
 * @generated
 */
public class PackagePackageContentCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getPackagePackageContentCompartment_7063SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getPackagePackageContentCompartment_7063SemanticChildren((View) getHost().getModel());
