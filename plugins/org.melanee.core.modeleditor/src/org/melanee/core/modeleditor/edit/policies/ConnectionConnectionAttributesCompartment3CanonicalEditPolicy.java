 ...
 * @generated
 */
public class ConnectionConnectionAttributesCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PLMPackage.eINSTANCE.getClabject_Feature();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionAttributesCompartment_7067SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return AttributeEditPart.VISUAL_ID == PLMVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionAttributesCompartment_7067SemanticChildren((View) getHost().getModel());
