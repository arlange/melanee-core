...
import org.melanee.core.modeleditor.edit.policies.Package2ItemSemanticEditPolicy;
...
public class Package2EditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof PackageName2EditPart) {
      ((PackageName2EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigurePackageNameFigure());
      return true;
    }
    if (childEditPart instanceof PackagePackageContentCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigurePackageContentRectangle();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((PackagePackageContentCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  protected boolean removeFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof PackagePackageContentCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigurePackageContentRectangle();
      pane.remove(((PackagePackageContentCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
    if (editPart instanceof PackagePackageContentCompartment2EditPart) {
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(PLMVisualIDRegistry.getType(PackageName2EditPart.VISUAL_ID));
  }
