 ...
 * @generated
 */
public class EntityEntityAttributesCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityAttributesCompartment_7064SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Attribute2EditPart.VISUAL_ID == PLMVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityAttributesCompartment_7064SemanticChildren((View) getHost().getModel());
