 ...
 * @generated
 */
public class ConnectionConnectionContentsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionContentsCompartment_7049SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionContentsCompartment_7049SemanticChildren((View) getHost().getModel());
