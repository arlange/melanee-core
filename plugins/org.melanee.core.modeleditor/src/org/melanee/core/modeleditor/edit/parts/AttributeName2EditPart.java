 ...
 * @generated
 */
public class AttributeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Attribute_3106, getParserElement(), PLMVisualIDRegistry
					.getType(org.melanee.core.modeleditor.edit.parts.AttributeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
