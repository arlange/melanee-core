 ...
 * @generated
 */
public class InheritanceCreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public InheritanceCreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    ElementInitializers.getInstance().init_Inheritance_3124(newElement);
