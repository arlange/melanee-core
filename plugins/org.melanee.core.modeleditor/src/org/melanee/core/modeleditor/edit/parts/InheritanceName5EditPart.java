 ...
 * @generated
 */
public class InheritanceName5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InheritanceName5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Inheritance_3128, getParserElement(),
					PLMVisualIDRegistry
							.getType(org.melanee.core.modeleditor.edit.parts.InheritanceName5EditPart.VISUAL_ID));
		}
		return parser;
	}
