 ...
 * @generated
 */
public class WrappingLabel54EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PLMVisualIDRegistry.getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel54EditPart.VISUAL_ID),
				new Point(10, 10));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.ConnectionEnd_4036, getParserElement(),
					PLMVisualIDRegistry
							.getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel54EditPart.VISUAL_ID));
		}
		return parser;
	}
