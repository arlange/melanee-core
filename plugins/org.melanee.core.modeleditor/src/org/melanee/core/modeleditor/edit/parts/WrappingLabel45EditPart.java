 ...
 * @generated
 */
public class WrappingLabel45EditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 5343;
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = PLMParserProvider.getParser(PLMElementTypes.Connection_3127, getParserElement(),
          PLMVisualIDRegistry
              .getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel45EditPart.VISUAL_ID));
    }
    return parser;
  }
