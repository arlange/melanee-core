	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel45EditPart) {
			((WrappingLabel45EditPart) childEditPart).setLabel(getPrimaryShape().getFigureConnectionNameFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel46EditPart) {
			((WrappingLabel46EditPart) childEditPart).setLabel(getPrimaryShape().getFigureConnectionLevelFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel47EditPart) {
			((WrappingLabel47EditPart) childEditPart).setLabel(getPrimaryShape().getFigureConnectionPotencyFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel48EditPart) {
			((WrappingLabel48EditPart) childEditPart).setLabel(getPrimaryShape().getFigureConnectionAVSFigure());
			return true;
		}
