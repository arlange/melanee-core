...
import org.melanee.core.modeleditor.edit.policies.Connection3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Connection3EditPart extends AbstractBorderedShapeEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 3127;
   ...
   * @generated
   */
  public Connection3EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Connection3ItemSemanticEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof ConnectionConnectionAttributesCompartment3EditPart) {
      IFigure pane = getPrimaryShape().getFigureAttributesCompartmentRectangle();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((ConnectionConnectionAttributesCompartment3EditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof ConnectionConnectionMethodsCompartment3EditPart) {
      IFigure pane = getPrimaryShape().getFigureMethodsCompartmentRectangle();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((ConnectionConnectionMethodsCompartment3EditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof ConnectionConnectionContentsCompartment3EditPart) {
      IFigure pane = getPrimaryShape().getFigureContentCompartmentRectangle();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((ConnectionConnectionContentsCompartment3EditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  protected boolean removeFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof ConnectionConnectionAttributesCompartment3EditPart) {
      IFigure pane = getPrimaryShape().getFigureAttributesCompartmentRectangle();
      pane.remove(((ConnectionConnectionAttributesCompartment3EditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof ConnectionConnectionMethodsCompartment3EditPart) {
      IFigure pane = getPrimaryShape().getFigureMethodsCompartmentRectangle();
      pane.remove(((ConnectionConnectionMethodsCompartment3EditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof ConnectionConnectionContentsCompartment3EditPart) {
      IFigure pane = getPrimaryShape().getFigureContentCompartmentRectangle();
      pane.remove(((ConnectionConnectionContentsCompartment3EditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
    if (editPart instanceof ConnectionConnectionAttributesCompartment3EditPart) {
      return getPrimaryShape().getFigureAttributesCompartmentRectangle();
    }
    if (editPart instanceof ConnectionConnectionMethodsCompartment3EditPart) {
      return getPrimaryShape().getFigureMethodsCompartmentRectangle();
    }
    if (editPart instanceof ConnectionConnectionContentsCompartment3EditPart) {
  ...
  protected void addBorderItem(IFigure borderItemContainer,
    ...
    if (borderItemEditPart instanceof ConnectionName3EditPart) {
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(PLMVisualIDRegistry.getType(WrappingLabel45EditPart.VISUAL_ID));
  }
    ...
    if (request instanceof CreateViewAndElementRequest) {
      ...
      if (type == PLMElementTypes.Attribute_3100) {
        return getChildBySemanticHint(PLMVisualIDRegistry
            .getType(ConnectionConnectionAttributesCompartment3EditPart.VISUAL_ID));
      }
  ...
  private void updateNameCompartment() {
    try {
      ...
      WrappingLabel classificationDesignationWrappingLabel =
          ...
          ((org.melanee.core.modeleditor.edit.parts.Connection3EditPart.ConnectionFigure) getPrimaryShape())
  ...
  public class ConnectionFigure extends ScalablePolygonShape {
    ...
    public ConnectionFigure() {
      ...
      this.setBorder(new MarginBorder(getMapMode().DPtoLP(3), getMapMode().DPtoLP(0),
    ...
    private void createContents() {
      ...
      fFigureConnectionProximityInheritanceFigure
          .setFont(FFIGURECONNECTIONPROXIMITYINHERITANCEFIGURE_FONT);
      ...
      fFigureConnectionPotencyFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(0),
          getMapMode().DPtoLP(0), getMapMode().DPtoLP(10), getMapMode().DPtoLP(0)));
      ...
      fFigureConnectionProximityClassificationFigure
          .setFont(FFIGURECONNECTIONPROXIMITYCLASSIFICATIONFIGURE_FONT);
      ...
      innerRectangle0.add(fFigureVisualizerCompartmentRectangle,
      ...
      fFigureVisualizerCompartmentRectangle
          .setLayoutManager(layoutFFigureVisualizerCompartmentRectangle);
   ...
   * @generated
   */
  static final Font FFIGURECONNECTIONPROXIMITYINHERITANCEFIGURE_FONT = new Font(
      Display.getCurrent(), Display.getDefault().getSystemFont().getFontData()[0].getName(), 9,
      SWT.NORMAL);

  /**
   * @generated
   */
  static final Font FFIGURECONNECTIONPROXIMITYCONTAINMENTFIGURE_FONT = new Font(
      Display.getCurrent(), Display.getDefault().getSystemFont().getFontData()[0].getName(), 9,
      SWT.NORMAL);
   ...
   * @generated
   */
  static final Font FFIGURECONNECTIONPROXIMITYCLASSIFICATIONFIGURE_FONT = new Font(
      Display.getCurrent(), Display.getDefault().getSystemFont().getFontData()[0].getName(), 9,
      SWT.NORMAL);
  ...
  /**
   * set new bounds so that the center of 'rect' matches the center of the new
   * bounds
   *
   * @generated
   */
  ...
  /**
   * This renders the ConnectionEditPart based on information in the model.
   * Collapsed means that the Connection is rendered as small black rectangle.
   * Collapsed means that the Connection will rendered as hexagon, its default
   * figure.
   * 
   * @generated
   */
  private void toggle() {
    ...
    // collapse element
      ...
      rf.setBorder(new LineBorder(
          PlatformUI.getWorkbench().getDisplay().getSystemColor(SWT.COLOR_WHITE), 2));
    ...
    public void notifyChanged(Notification notification) {
      ...
      for (Clabject i : instances) {
        ...
        if (ep instanceof EntityEditPart)
          ...
          ((org.melanee.core.modeleditor.edit.parts.Connection3EditPart) ep)
              .updateView(IVisualizationServiceBase.FORMAT_GRAPH);
      }
    }
  }
