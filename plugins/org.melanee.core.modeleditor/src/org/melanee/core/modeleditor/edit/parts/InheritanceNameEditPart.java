 ...
 * @generated
 */
public class InheritanceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 5333;
	...
	* @generated
	*/
	public InheritanceNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Inheritance_3124, getParserElement(),
					PLMVisualIDRegistry
							.getType(org.melanee.core.modeleditor.edit.parts.InheritanceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
