 ...
 * @generated
 */
public class Inheritance2CreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public Inheritance2CreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    ElementInitializers.getInstance().init_Inheritance_3122(newElement);
