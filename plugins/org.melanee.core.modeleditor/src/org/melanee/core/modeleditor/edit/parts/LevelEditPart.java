...
public class LevelEditPart extends ShapeNodeEditPart {
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
        new OneDirectionResizableEditPolicy(PositionConstants.SOUTH));
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof LevelNameEditPart) {
      ((LevelNameEditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureDeepModelLevelNameFigure());
      return true;
    }
    if (childEditPart instanceof WrappingLabel3EditPart) {
      ((WrappingLabel3EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureDeepModelLevelAVSFigure());
      return true;
    }
  ...
  public class ModelFigure extends RectangleFigure {
    ...
    private void createContents() {
      ...
      nameRectangle0.add(fFigureDeepModelLevelNameFigure,
          constraintFFigureDeepModelLevelNameFigure);
  ...
  public Command getCommand(Request _request) {
    getFigure().invalidateTree(); // ensure that the LevelDomainElementsCompartment's figure has
                                  // properly set bounds
    ...
    if (cmd == null && _request instanceof CreateUnspecifiedTypeRequest) {
      ...
      if (createUnspecifiedTypeRequest.getElementTypes().contains(PLMElementTypes.Entity_3105)
          || createUnspecifiedTypeRequest.getElementTypes()
              .contains(PLMElementTypes.Package_3125)) {
      ...
      } else if (createUnspecifiedTypeRequest.getElementTypes()
          .contains(PLMElementTypes.Level_3097)) {
