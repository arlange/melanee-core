...
public class PackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public static final int VISUAL_ID = 5336;
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Package_3125, getParserElement(),
					PLMVisualIDRegistry.getType(org.melanee.core.modeleditor.edit.parts.PackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
