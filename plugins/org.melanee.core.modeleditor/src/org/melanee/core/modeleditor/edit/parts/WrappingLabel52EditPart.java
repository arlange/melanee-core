 ...
 * @generated
 */
public class WrappingLabel52EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PLMVisualIDRegistry.getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel52EditPart.VISUAL_ID),
				new Point(10, 10));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Classification_4026, getParserElement(),
					PLMVisualIDRegistry
							.getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel52EditPart.VISUAL_ID));
		}
		return parser;
	}
