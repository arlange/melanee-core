 ...
 * @generated
 */
public class ConnectionNameExternalLabel2EditPart extends LabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 5319;
	...
	*/
	static {
		registerSnapBackPosition(
				PLMVisualIDRegistry.getType(
						org.melanee.core.modeleditor.edit.parts.ConnectionNameExternalLabel2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ConnectionNameExternalLabel2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Entity_3120, getParserElement(),
