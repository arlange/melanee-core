...
import org.melanee.core.modeleditor.edit.policies.ConnectionConnectionContentsCompartment3CanonicalEditPolicy;
import org.melanee.core.modeleditor.edit.policies.ConnectionConnectionContentsCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ConnectionConnectionContentsCompartment3EditPart extends ShapeCompartmentEditPart {
   ...
   * @generated
   */
  public ConnectionConnectionContentsCompartment3EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new ConnectionConnectionContentsCompartment3ItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.CREATION_ROLE,
        new CreationEditPolicyWithCustomReparent(PLMVisualIDRegistry.TYPED_INSTANCE));
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
        new ConnectionConnectionContentsCompartment3CanonicalEditPolicy());
