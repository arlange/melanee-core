 ...
 * @generated
 */
public class WrappingLabel33EditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 5335;
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = PLMParserProvider.getParser(PLMElementTypes.Inheritance_3124, getParserElement(),
          PLMVisualIDRegistry
              .getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel33EditPart.VISUAL_ID));
    }
    return parser;
  }
  ...
  private OclTracker.Registrator getOclRegistrator() {
    if (myOclRegistrator == null) {
      myOclRegistrator = new OclTracker.Registrator() {
        ...
        @Override
        public void registerListener(String filterId, NotificationListener listener,
            EObject element) {
