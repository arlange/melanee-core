 ...
 * @generated
 */
public class ConnectionConnectionContentsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PLMPackage.eINSTANCE.getClabject_Content();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionContentsCompartment_7056SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		int visualID = PLMVisualIDRegistry.getVisualID(view);
		return visualID == EntityEditPart.VISUAL_ID || visualID == Connection2EditPart.VISUAL_ID
				|| visualID == InheritanceEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getConnectionConnectionContentsCompartment_7056SemanticChildren((View) getHost().getModel());
		...
		for (Iterator<PLMNodeDescriptor> descriptorsIterator = childDescriptors.iterator(); descriptorsIterator
				.hasNext();) {
