 ...
 * @generated
 */
public class EntityEntityMethodsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityMethodsCompartment_7065SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Method2EditPart.VISUAL_ID == PLMVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityMethodsCompartment_7065SemanticChildren((View) getHost().getModel());
