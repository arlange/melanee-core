 ...
 * @generated
 */
public class InheritanceName6EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 5350;
	...
	*/
	static {
		registerSnapBackPosition(
				PLMVisualIDRegistry.getType(org.melanee.core.modeleditor.edit.parts.InheritanceName6EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public InheritanceName6EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new PLMTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Inheritance_3128, getParserElement(),
					PLMVisualIDRegistry
							.getType(org.melanee.core.modeleditor.edit.parts.InheritanceName6EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, PLMEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new GeneralizationExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GeneralizationExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureGeneralizationNameExternalFigure;
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureGeneralizationNameExternalFigure() {
