...
import org.melanee.core.modeleditor.edit.policies.AttributeItemSemanticEditPolicy;
...
public class AttributeEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof AttributeNameEditPart) {
      ((AttributeNameEditPart) childEditPart)
    ...
    if (childEditPart instanceof WrappingLabel9EditPart) {
      ((WrappingLabel9EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureAttributeDurabilityFigure());
      return true;
    }
    if (childEditPart instanceof WrappingLabel10EditPart) {
      ((WrappingLabel10EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureAttributeDataTypeFigure());
      return true;
    }
    ...
    if (childEditPart instanceof WrappingLabel12EditPart) {
      ((WrappingLabel12EditPart) childEditPart)
          .setLabel(getPrimaryShape().getFigureAttributeVariabilityFigure());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(PLMVisualIDRegistry.getType(AttributeNameEditPart.VISUAL_ID));
  }
  ...
  public class AttributeFigure extends RectangleFigure {
    ...
    public AttributeFigure() {
      ...
      this.setBorder(new MarginBorder(getMapMode().DPtoLP(0), getMapMode().DPtoLP(0),
    ...
    private void createContents() {
      ...
      fFigureAttributeDurabilityFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(0),
      ...
      innerRectangle0.add(fFigureAttributeDurabilityFigure,
          constraintFFigureAttributeDurabilityFigure);
      ...
      innerRectangle0.add(fFigureAttributeDefaultValueFigure,
          constraintFFigureAttributeDefaultValueFigure);
      ...
      fFigureAttributeVariabilityFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(0),
          getMapMode().DPtoLP(0), getMapMode().DPtoLP(10), getMapMode().DPtoLP(0)));
      ...
      innerRectangle0.add(fFigureAttributeVariabilityFigure,
          constraintFFigureAttributeVariabilityFigure);
    ...
    if (_request instanceof CreateUnspecifiedTypeConnectionRequest
      ...
      if (((CreateUnspecifiedTypeConnectionRequest) _request).getTargetEditPart() == this)
        ((CreateUnspecifiedTypeConnectionRequest) _request)
            .setTargetEditPart(getParent().getParent());

      if (((CreateUnspecifiedTypeConnectionRequest) _request).getSourceEditPart() == this)
        ((CreateUnspecifiedTypeConnectionRequest) _request)
            .setSourceEditPart(getParent().getParent());
