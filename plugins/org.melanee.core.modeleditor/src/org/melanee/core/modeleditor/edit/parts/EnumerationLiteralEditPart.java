...
public class EnumerationLiteralEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public static final int VISUAL_ID = 5330;
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = PLMParserProvider.getParser(PLMElementTypes.Enumeration_3123, getParserElement(),
          PLMVisualIDRegistry.getType(
              org.melanee.core.modeleditor.edit.parts.EnumerationLiteralEditPart.VISUAL_ID));
    }
    return parser;
  }
