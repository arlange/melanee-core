...
import org.melanee.core.modeleditor.edit.policies.Connection2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Connection2EditPart extends AbstractBorderedShapeEditPart {
   ...
   * @generated
   */
  public Connection2EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Connection2ItemSemanticEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof ConnectionConnectionAttributesCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigureAttributesCompartmentRectangle();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((ConnectionConnectionAttributesCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof ConnectionConnectionMethodsCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigureMethodsCompartmentRectangle();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((ConnectionConnectionMethodsCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof ConnectionConnectionContentsCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigureContentCompartmentRectangle();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((ConnectionConnectionContentsCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  protected boolean removeFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof ConnectionConnectionAttributesCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigureAttributesCompartmentRectangle();
      pane.remove(((ConnectionConnectionAttributesCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof ConnectionConnectionMethodsCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigureMethodsCompartmentRectangle();
      pane.remove(((ConnectionConnectionMethodsCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof ConnectionConnectionContentsCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigureContentCompartmentRectangle();
      pane.remove(((ConnectionConnectionContentsCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
    if (editPart instanceof ConnectionConnectionAttributesCompartment2EditPart) {
      return getPrimaryShape().getFigureAttributesCompartmentRectangle();
    }
    if (editPart instanceof ConnectionConnectionMethodsCompartment2EditPart) {
      return getPrimaryShape().getFigureMethodsCompartmentRectangle();
    }
    if (editPart instanceof ConnectionConnectionContentsCompartment2EditPart) {
  ...
  protected void addBorderItem(IFigure borderItemContainer,
    ...
    if (borderItemEditPart instanceof ConnectionName2EditPart) {
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(PLMVisualIDRegistry.getType(WrappingLabel28EditPart.VISUAL_ID));
  }
    ...
    if (request instanceof CreateViewAndElementRequest) {
      ...
      if (type == PLMElementTypes.Attribute_3100) {
        return getChildBySemanticHint(PLMVisualIDRegistry
            .getType(ConnectionConnectionAttributesCompartment2EditPart.VISUAL_ID));
      }
  ...
  private void updateNameCompartment() {
    try {
      ...
      WrappingLabel classificationDesignationWrappingLabel =
          ...
          ((org.melanee.core.modeleditor.edit.parts.Connection2EditPart.ConnectionFigure) getPrimaryShape())
    ...
    public void notifyChanged(Notification notification) {
      ...
      for (Clabject i : instances) {
        ...
        if (ep instanceof EntityEditPart)
          ...
          ((org.melanee.core.modeleditor.edit.parts.Connection2EditPart) ep)
              .updateView(IVisualizationServiceBase.FORMAT_GRAPH);
