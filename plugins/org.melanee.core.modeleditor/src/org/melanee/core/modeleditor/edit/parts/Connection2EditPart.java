	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel28EditPart) {
			((WrappingLabel28EditPart) childEditPart).setLabel(getPrimaryShape().getFigureConnectionNameFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel29EditPart) {
			((WrappingLabel29EditPart) childEditPart).setLabel(getPrimaryShape().getFigureConnectionLevelFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel30EditPart) {
			((WrappingLabel30EditPart) childEditPart).setLabel(getPrimaryShape().getFigureConnectionPotencyFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel31EditPart) {
			((WrappingLabel31EditPart) childEditPart).setLabel(getPrimaryShape().getFigureConnectionAVSFigure());
			return true;
		}
