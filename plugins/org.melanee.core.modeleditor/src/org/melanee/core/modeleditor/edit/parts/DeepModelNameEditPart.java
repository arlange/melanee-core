 ...
 * @generated
 */
public class DeepModelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 5331;
	...
	* @generated
	*/
	public DeepModelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.DeepModel_2005, getParserElement(), PLMVisualIDRegistry
					.getType(org.melanee.core.modeleditor.edit.parts.DeepModelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
