 ...
 * @generated
 */
public class WrappingLabel30EditPart extends CompartmentEditPart implements ITextAwareEditPart {

  /**
   * @generated
   */
  public static final int VISUAL_ID = 5285;
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = PLMParserProvider.getParser(PLMElementTypes.Connection_3111, getParserElement(),
          PLMVisualIDRegistry
              .getType(org.melanee.core.modeleditor.edit.parts.WrappingLabel30EditPart.VISUAL_ID));
    }
    return parser;
  }
