 ...
 * @generated
 */
public class EntityEntityAttributesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityAttributesCompartment_7051SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityAttributesCompartment_7051SemanticChildren((View) getHost().getModel());
