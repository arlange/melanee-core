 ...
 * @generated
 */
public class PackagePackageContentCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PLMPackage.eINSTANCE.getPackage_Content();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getPackagePackageContentCompartment_7070SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getPackagePackageContentCompartment_7070SemanticChildren((View) getHost().getModel());
