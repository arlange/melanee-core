 ...
 * @generated
 */
public class Inheritance2ItemSemanticEditPolicy extends PLMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Inheritance2ItemSemanticEditPolicy() {
		super(PLMElementTypes.Inheritance_3122);
	}
