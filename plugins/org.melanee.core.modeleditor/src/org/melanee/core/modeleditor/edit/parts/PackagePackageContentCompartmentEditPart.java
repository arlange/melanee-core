...
import org.melanee.core.modeleditor.edit.policies.PackagePackageContentCompartmentCanonicalEditPolicy;
import org.melanee.core.modeleditor.edit.policies.PackagePackageContentCompartmentItemSemanticEditPolicy;
import org.melanee.core.modeleditor.providers.PLMElementTypes;

/**
 * @generated
 */
public class PackagePackageContentCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public PackagePackageContentCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PackagePackageContentCompartmentItemSemanticEditPolicy());

		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());

		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new PackagePackageContentCompartmentCanonicalEditPolicy());
