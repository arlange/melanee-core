 ...
 * @generated
 */
public class InheritanceName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 5334;
	...
	*/
	static {
		registerSnapBackPosition(
				PLMVisualIDRegistry.getType(org.melanee.core.modeleditor.edit.parts.InheritanceName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public InheritanceName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PLMParserProvider.getParser(PLMElementTypes.Inheritance_3124, getParserElement(),
					PLMVisualIDRegistry
							.getType(org.melanee.core.modeleditor.edit.parts.InheritanceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
