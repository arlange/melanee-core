 ...
 * @generated
 */
public class EntityEntityContentsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityContentsCompartment_7053SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PLMNodeDescriptor> childDescriptors = PLMDiagramUpdater
				.getEntityEntityContentsCompartment_7053SemanticChildren((View) getHost().getModel());
