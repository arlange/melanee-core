...
public class PLMVisualIDRegistry {
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = org.melanee.core.modeleditor.part.PLMVisualIDRegistry.getModelID(containerView);
		if (!DomainEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (DomainEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = org.melanee.core.modeleditor.part.PLMVisualIDRegistry.getVisualID(containerView);
		} else {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return org.melanee.core.modeleditor.part.PLMVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return org.melanee.core.modeleditor.part.PLMVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
