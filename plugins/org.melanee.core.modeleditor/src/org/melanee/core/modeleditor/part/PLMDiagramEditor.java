...
import org.melanee.core.modeleditor.editortoolbaritems.ModelToTextAction;
import org.melanee.core.modeleditor.editortoolbaritems.SelectComplianceModeContributionItem;
import org.melanee.core.modeleditor.editortoolbaritems.TextToModelAction;
...
public class PLMDiagramEditor extends DiagramDocumentEditor implements IGotoMarker {
  ...
  public TransactionalEditingDomain getEditingDomain() {
    IDocument document =
        getEditorInput() != null ? getDocumentProvider().getDocument(getEditorInput()) : null;
    ...
    public void selectionChanged(IWorkbenchPart part, ISelection selection) {
      ...
      PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage() != null
        ...
        IGraphicalEditPart editPart =
            (IGraphicalEditPart) ((IStructuredSelection) selection).getFirstElement();
  ...
  private void managePalette(Element selectedElement) {
    ...
    while (contentIterator.hasNext()) {
      ...
      if (e instanceof Entity && ((Clabject) e).getPotency() != 0 && e.getName() != null) {
        ...
        org.melanee.core.modeleditor.part.PLMDiagramEditor.NodeToolEntry entry =
            new org.melanee.core.modeleditor.part.PLMDiagramEditor.NodeToolEntry(e.getName(),
                "Creates a new " + e.getName(), types);
    ...
    org.melanee.core.modeleditor.part.PLMDiagramEditor.LinkToolEntry entry =
        new org.melanee.core.modeleditor.part.PLMDiagramEditor.LinkToolEntry(
  ...
  public void createPartControl(Composite parent) {
    ...
    ConstraintLanguageServiceResourceSetListener.getInstance()
  ...
  protected void createGraphicalViewer(Composite parent) {
    ...
    Action alignTop = new AlignAction(this.getSite().getPage(), GEFActionConstants.ALIGN_TOP,
        PositionConstants.TOP, true);
    ...
    // Compatibility Mode
    toolBarManager.add(new Separator());
    ContributionItem selectCompatibilityMode = new SelectComplianceModeContributionItem(
        this.getSite().getPage(), (Domain) getDiagram().getElement());
    ...
    Action text2Model = new ModelToTextAction((Domain) getDiagram().getElement());
    toolBarManager.add(text2Model);
    Action model2Text = new TextToModelAction((Domain) getDiagram().getElement());
    toolBarManager.add(model2Text);
