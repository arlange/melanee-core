...
public class PLMPaletteFactory {
  ...
  private ToolEntry createDeepModel1CreationTool() {
    DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.DeepModel1CreationTool_title,
        Messages.DeepModel1CreationTool_desc,
        Collections.singletonList(PLMElementTypes.DeepModel_2005));

    entry.setId("createDeepModel1CreationTool"); //$NON-NLS-1$

    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/ontology16.gif")); //$NON-NLS-1$
  ...
  private ToolEntry createLevel2CreationTool() {
    ...
    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/model16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/model16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createEnumeration3CreationTool() {
    DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Enumeration3CreationTool_title,
        Messages.Enumeration3CreationTool_desc,
        Collections.singletonList(PLMElementTypes.Enumeration_3123));

    entry.setId("createEnumeration3CreationTool"); //$NON-NLS-1$

    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/enumeration16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/enumeration16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createConnectionRole2CreationTool() {
    DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
        Messages.ConnectionRole2CreationTool_title, Messages.ConnectionRole2CreationTool_desc,
        Collections.singletonList(PLMElementTypes.ConnectionEnd_4036));

    entry.setId("createConnectionRole2CreationTool"); //$NON-NLS-1$

    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/connection16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/connection16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createAttribute3CreationTool() {
    ...
    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/field16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/field16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createMethod4CreationTool() {
    ...
    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/method16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/method16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createClassification1CreationTool() {
    DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
        Messages.Classification1CreationTool_title, Messages.Classification1CreationTool_desc,
        Collections.singletonList(PLMElementTypes.Classification_4026));

    entry.setId("createClassification1CreationTool"); //$NON-NLS-1$

    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/classification16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/classification16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createInheritance2CreationTool() {
    ...
    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/inheritance16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/inheritance16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createSuperSubtype3CreationTool() {
    ...
    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/superType16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/superType16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createComplement4CreationTool() {
    ToolEntry entry = new ToolEntry(Messages.Complement4CreationTool_title,
        Messages.Complement4CreationTool_desc, null, null) {
    };

    entry.setId("createComplement4CreationTool"); //$NON-NLS-1$

    entry.setSmallIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/setRelationship16.gif")); //$NON-NLS-1$
    entry.setLargeIcon(PLMDiagramEditorPlugin
        .findImageDescriptor("/org.melanee.core.models.gmf/icons/setRelationship16.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createEqual5CreationTool() {
    ToolEntry entry = new ToolEntry(Messages.Equal5CreationTool_title,
        Messages.Equal5CreationTool_desc, null, null) {
    };
  ...
  private ToolEntry createInversion6CreationTool() {
    ToolEntry entry = new ToolEntry(Messages.Inversion6CreationTool_title,
        Messages.Inversion6CreationTool_desc, null, null) {
    };
