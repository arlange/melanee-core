 ...
 * @generated
 */
public class ConnectionLabelExpressionLabelParser5343 extends ExpressionLabelParserBase {
	/**
	* @generated
	*/
	public ConnectionLabelExpressionLabelParser5343() {
	}
	...
	*/
	...
	protected String getExpressionBody() {
		return PLMOCLFactory.getExpression(31, PLMPackage.eINSTANCE.getConnection(), null).body();
	}
	...
	*/
	private IStatus updateValues(EObject target, String newString) throws ExecutionException {
		...
		//**************************************
		((Element) target).setName(newString);
