...
public class ElementInitializers {
	...
	public void init_Attribute_3100(Attribute instance) {
		...
		try {
			...
			/*
			 * Object value_0 = PLMOCLFactory.getExpression(52,
			 * PLMPackage.eINSTANCE.getAttribute(), null) .evaluate(instance);
			 * 
			 * value_0 = PLMAbstractExpression.performCast(value_0,
			 * EcorePackage.eINSTANCE.getEInt()); instance.setParsingOrder(((Integer)
			 * value_0).intValue());
			 * 
			 */
