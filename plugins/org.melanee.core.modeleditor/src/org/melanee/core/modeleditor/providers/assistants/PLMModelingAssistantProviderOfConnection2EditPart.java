 ...
 * @generated
 */
public class PLMModelingAssistantProviderOfConnection2EditPart
   ...
   * @generated
   */
  public List<IElementType> doGetTypesForTarget(Connection2EditPart source,
   ...
   * @generated
   */
  public List<IElementType> doGetTypesForSource(Connection2EditPart target,
      IElementType relationshipType) {
    List<IElementType> types = new ArrayList<IElementType>();
    if (relationshipType == PLMElementTypes.Classification_4026) {
      types.add(PLMElementTypes.Connection_3099);
