 ...
 * @generated
 */
public class PLMNavigatorLabelProvider extends LabelProvider
  ...
  public Image getImage(View view) {
    ...
    case DomainEditPart.VISUAL_ID:
      return getImage("Navigator?Diagram?http://melanee.org/PLM?Domain", //$NON-NLS-1$
          PLMElementTypes.Domain_1000);
    case DeepModelEditPart.VISUAL_ID:
      return getImage("Navigator?TopLevelNode?http://melanee.org/PLM?DeepModel", //$NON-NLS-1$
          PLMElementTypes.DeepModel_2005);
    ...
    case ConnectionEditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Connection", //$NON-NLS-1$
          PLMElementTypes.Connection_3099);
    case AttributeEditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Attribute", //$NON-NLS-1$
          PLMElementTypes.Attribute_3100);
    ...
    case Attribute2EditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Attribute", //$NON-NLS-1$
          PLMElementTypes.Attribute_3106);
    ...
    case Connection2EditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Connection", //$NON-NLS-1$
          PLMElementTypes.Connection_3111);
    ...
    case Inheritance2EditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Inheritance", //$NON-NLS-1$
          PLMElementTypes.Inheritance_3122);
    case EnumerationEditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Enumeration", //$NON-NLS-1$
          PLMElementTypes.Enumeration_3123);
    case InheritanceEditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Inheritance", //$NON-NLS-1$
          PLMElementTypes.Inheritance_3124);
    case PackageEditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Package", //$NON-NLS-1$
          PLMElementTypes.Package_3125);
    ...
    case Connection3EditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Connection", //$NON-NLS-1$
          PLMElementTypes.Connection_3127);
    case Inheritance3EditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Inheritance", //$NON-NLS-1$
          PLMElementTypes.Inheritance_3128);
    case Package2EditPart.VISUAL_ID:
      return getImage("Navigator?Node?http://melanee.org/PLM?Package", //$NON-NLS-1$
          PLMElementTypes.Package_3129);
    ...
    case SupertypeEditPart.VISUAL_ID:
      return getImage("Navigator?Link?http://melanee.org/PLM?Supertype", //$NON-NLS-1$
          PLMElementTypes.Supertype_4034);
    case SubtypeEditPart.VISUAL_ID:
      return getImage("Navigator?Link?http://melanee.org/PLM?Subtype", //$NON-NLS-1$
          PLMElementTypes.Subtype_4035);
    case ConnectionEndEditPart.VISUAL_ID:
      return getImage("Navigator?Link?http://melanee.org/PLM?ConnectionEnd", //$NON-NLS-1$
          PLMElementTypes.ConnectionEnd_4036);
    }
