...
public class PLMNavigatorContentProvider implements ICommonContentProvider {
  ...
  public Object[] getChildren(Object parentElement) {
    if (parentElement instanceof IFile) {
      ...
      result.addAll(
          createNavigatorItems(selectViewsByType(topViews, DomainEditPart.MODEL_ID), file, false));
  ...
  private Object[] getViewChildren(View view, Object parentElement) {
    ...
    case DeepModelEditPart.VISUAL_ID: {
      ...
      connectedViews = getChildrenByType(connectedViews,
          PLMVisualIDRegistry.getType(LevelEditPart.VISUAL_ID));
      result.addAll(createNavigatorItems(connectedViews, parentElement, false));
      return result.toArray();
    }
    ...
    case LevelEditPart.VISUAL_ID: {
      ...
      connectedViews = getChildrenByType(Collections.singleton(sv),
          PLMVisualIDRegistry.getType(LevelDomainElementsCompartmentEditPart.VISUAL_ID));
      connectedViews = getChildrenByType(connectedViews,
          PLMVisualIDRegistry.getType(PackageEditPart.VISUAL_ID));
      result.addAll(createNavigatorItems(connectedViews, parentElement, false));
      return result.toArray();
    }
    ...
    case ConnectionEditPart.VISUAL_ID: {
      ...
      PLMNavigatorGroup incominglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Connection_3099_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Connection_3099_outgoinglinks,
      ...
      connectedViews = getChildrenByType(connectedViews,
          PLMVisualIDRegistry.getType(MethodEditPart.VISUAL_ID));
      result.addAll(createNavigatorItems(connectedViews, parentElement, false));
      connectedViews = getChildrenByType(Collections.singleton(sv),
    ...
    case EntityEditPart.VISUAL_ID: {
      ...
      Node sv = (Node) view;
      PLMNavigatorGroup incominglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Entity_3105_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Entity_3105_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getChildrenByType(Collections.singleton(sv),
      ...
      connectedViews = getChildrenByType(connectedViews,
          PLMVisualIDRegistry.getType(Method2EditPart.VISUAL_ID));
      result.addAll(createNavigatorItems(connectedViews, parentElement, false));
      connectedViews = getChildrenByType(Collections.singleton(sv),
    ...
    case Connection2EditPart.VISUAL_ID: {
      ...
      Node sv = (Node) view;
      PLMNavigatorGroup incominglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Connection_3111_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Connection_3111_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getChildrenByType(Collections.singleton(sv), PLMVisualIDRegistry
    ...
    case Entity2EditPart.VISUAL_ID: {
      ...
      Node sv = (Node) view;
      PLMNavigatorGroup incominglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Entity_3120_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Entity_3120_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getChildrenByType(Collections.singleton(sv),
    ...
    case Inheritance2EditPart.VISUAL_ID: {
      ...
      Node sv = (Node) view;
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Inheritance_3122_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
    ...
    case InheritanceEditPart.VISUAL_ID: {
      ...
      Node sv = (Node) view;
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Inheritance_3124_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
    ...
    case PackageEditPart.VISUAL_ID: {
      ...
      connectedViews = getChildrenByType(Collections.singleton(sv),
          PLMVisualIDRegistry.getType(PackagePackageContentCompartmentEditPart.VISUAL_ID));
      connectedViews = getChildrenByType(connectedViews,
          PLMVisualIDRegistry.getType(Package2EditPart.VISUAL_ID));
      result.addAll(createNavigatorItems(connectedViews, parentElement, false));
      return result.toArray();
    }
    ...
    case Entity3EditPart.VISUAL_ID: {
      ...
      Node sv = (Node) view;
      PLMNavigatorGroup incominglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Entity_3126_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Entity_3126_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getChildrenByType(Collections.singleton(sv),
    ...
    case Connection3EditPart.VISUAL_ID: {
      ...
      Node sv = (Node) view;
      PLMNavigatorGroup incominglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Connection_3127_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Connection_3127_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getChildrenByType(Collections.singleton(sv), PLMVisualIDRegistry
    ...
    case Inheritance3EditPart.VISUAL_ID: {
      ...
      Node sv = (Node) view;
      PLMNavigatorGroup outgoinglinks = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Inheritance_3128_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
    ...
    case ClassificationEditPart.VISUAL_ID: {
      LinkedList<PLMAbstractNavigatorItem> result = new LinkedList<PLMAbstractNavigatorItem>();
      Edge sv = (Edge) view;
      PLMNavigatorGroup target = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Classification_4026_target,
          "icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      PLMNavigatorGroup source = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Classification_4026_source,
    ...
    case SupertypeEditPart.VISUAL_ID: {
      ...
      Edge sv = (Edge) view;
      PLMNavigatorGroup target = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Supertype_4034_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      PLMNavigatorGroup source = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Supertype_4034_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getLinksTargetByType(Collections.singleton(sv),
          PLMVisualIDRegistry.getType(ConnectionEditPart.VISUAL_ID));
    ...
    case SubtypeEditPart.VISUAL_ID: {
      ...
      Edge sv = (Edge) view;
      PLMNavigatorGroup target = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Subtype_4035_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      PLMNavigatorGroup source = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_Subtype_4035_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
          parentElement);
      Collection<View> connectedViews;
      connectedViews = getLinksTargetByType(Collections.singleton(sv),
          PLMVisualIDRegistry.getType(ConnectionEditPart.VISUAL_ID));
    ...
    case ConnectionEndEditPart.VISUAL_ID: {
      ...
      Edge sv = (Edge) view;
      PLMNavigatorGroup target = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_ConnectionEnd_4036_target,
          "icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      PLMNavigatorGroup source = new PLMNavigatorGroup(
          Messages.NavigatorGroupName_ConnectionEnd_4036_source,
          "icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection<View> connectedViews;
      connectedViews = getLinksTargetByType(Collections.singleton(sv),
          PLMVisualIDRegistry.getType(ConnectionEditPart.VISUAL_ID));
   ...
   * @generated
   */
  private Collection<PLMNavigatorItem> createNavigatorItems(Collection<View> views, Object parent,
      boolean isLeafs) {
