...
public class OntologicalPropertySectionAbstractPropertySection extends AdvancedPropertySection {
      ...
      if (r != null && r instanceof Clabject) {
        ...
        for (int i = 0; i < descriptors.length; i++) {
          ...
          if (attribute.isEnumeration()) {
            ...
            descriptors[i] = new ComboBoxPropertyDescriptor(attributes.keySet().toArray()[i],
                attribute.getName(), allValues.toArray(new String[] {}));
          } else
            descriptors[i] = new TextPropertyDescriptor(attributes.keySet().toArray()[i],
                attribute.getName());
  ...
  class OntologicalPropertySource implements IPropertySource {
    ...
    public void setPropertyValue(Object id, Object value) {
      ...
      cmd = new SetCommand(domain, attribute, PLMPackageImpl.eINSTANCE.getAttribute_Value(),
          translatedValue);
