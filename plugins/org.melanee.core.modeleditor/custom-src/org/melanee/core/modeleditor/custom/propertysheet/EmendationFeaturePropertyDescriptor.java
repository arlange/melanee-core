...
public class EmendationFeaturePropertyDescriptor extends PropertyDescriptor {
  ...
  public EmendationFeaturePropertyDescriptor(Object sourceObject,
  ...
  public CellEditor createPropertyEditor(final Composite composite) {
    ...
    final EStructuralFeature feature = (EStructuralFeature) itemPropertyDescriptor
        .getFeature(sourceObject);

    // *******************************************
    // These are the features that can be emended
    // ********************************************
    if (feature instanceof EStructuralFeature && !itemPropertyDescriptor.isMany(feature)
      ...
      if (feature.getEType().getInstanceClass() == Boolean.class
        ...
        return new ExtendedComboBoxCellEditor(composite,
            Arrays.asList(new Object[] { Boolean.FALSE, Boolean.TRUE }), getEditLabelProvider(),
