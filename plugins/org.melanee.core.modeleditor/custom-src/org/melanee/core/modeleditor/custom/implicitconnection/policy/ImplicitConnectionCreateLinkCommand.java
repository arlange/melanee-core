...
public class ImplicitConnectionCreateLinkCommand extends CompositeCommand {
  ...
  private static final String REQUEST_PARAMETER_KEY = ImplicitConnectionCreateLinkCommand.class
      .getCanonicalName() + ":request:parameter:key"; //$NON-NLS-1$
  ...
  public ImplicitConnectionCreateLinkCommand(TransactionalEditingDomain domain,
  ...
  public boolean canExecute() {
    ...
    if (mySetConnectionBendpointsCommand != null
        && !mySetConnectionBendpointsCommand.canExecute()) {
      return false;
    }
    if (isEmpty()) {
  ...
  public void setSetConnectionAnchorsCommand(
      SetConnectionAnchorsCommand setConnectionAnchorsCommand) {
    assertNotExecuted();
  ...
  public void setSetConnectionBendpointsCommand(
      SetConnectionBendpointsCommand setConnectionBendpointsCommand) {
    assertNotExecuted();
  ...
  public static ImplicitConnectionCreateLinkCommand getFromRequest(Request request) {
    return (ImplicitConnectionCreateLinkCommand) request.getExtendedData()
        .get(REQUEST_PARAMETER_KEY);
  }
  ...
  // TODO: implement undo
  /**
   * Needs to be overriden because the defaul GraphicalNodeEditPolicy goes through
   * the commands by using an interator instead of get/set. Just filling the array
   * will break the one-click connection + 2 roles creation
   */
  // @Override
  ...
  private class ITMIterator implements ListIterator {
    ...
    public void add(Object e) {
      throw new UnsupportedOperationException(
          "Addition of Commands from this Command is not supported. Use getters and setters instead.");
    }
    ...
    public void remove() {
      throw new UnsupportedOperationException(
          "Removal of Commands from this Command is not supported. Use getters and setters instead.");
