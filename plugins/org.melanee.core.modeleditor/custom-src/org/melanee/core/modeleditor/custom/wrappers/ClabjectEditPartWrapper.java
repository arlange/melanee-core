...
/**
 *
 * A wrapper to allow convenient access to common methods of EntityEditPart,
 * Entity2EditPart, ConnectionEditPart, Connection2EditPart.
 *
 */
public class ClabjectEditPartWrapper {
  ...
  /**
   * 
   * Creates a new instance of the wrapper with the passed edit part
   * 
   * @param clabjectEditPart
   *          the editpart to wrap
   */
  public ClabjectEditPartWrapper(Object clabjectEditPart) {
    // Assert to wrap the right type only
    Assert.isTrue(
        clabjectEditPart instanceof Entity2EditPart || clabjectEditPart instanceof EntityEditPart
