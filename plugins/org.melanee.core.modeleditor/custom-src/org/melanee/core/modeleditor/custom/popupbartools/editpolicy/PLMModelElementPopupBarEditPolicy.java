/// *******************************************************************************
// * Copyright (c) 2011, 2012 University of Mannheim: Chair for Software
/// Engineering
...
// import
/// org.melanee.core.modeleditor.custom.popupbartools.InstantiatatePopupBarTool;
// import
/// org.melanee.core.modeleditor.custom.popupbartools.OpenTextualModelEditorPopupBarTool;
// import
/// org.melanee.core.modeleditor.custom.popupbartools.SeparatorPopupBarTool;
...
// import
/// org.melanee.core.workbench.interfaces.IPopupToolBarProvider.PopupToolBarToolWrapper;
//
...
// Map<String, List<PopupToolBarToolWrapper>> groups2tools = new HashMap<String,
/// List<PopupToolBarToolWrapper>>();
//
// /***********************************************************
...
/// Entity)
// && ! (((IGraphicalEditPart)getHost()).resolveSemanticElement() instanceof
/// Model)
// && ! (((IGraphicalEditPart)getHost()).resolveSemanticElement() instanceof
/// SetRelationship)
// ){
...
//
// PopupToolBarToolWrapper toolWrapper = new PopupToolBarToolWrapper(image,
/// tool, "Expand/Collapse", "connector");
//
...
/// null){
//
// tool = new OpenTextualModelEditorPopupBarTool((IGraphicalEditPart)getHost(),
/// null);
//
// imageDescriptor = Activator.imageDescriptorFromPlugin(Activator.PLUGIN_ID,
/// "/icons/popup/text16.gif");
// image = imageDescriptor.createImage();
//
// PopupToolBarToolWrapper toolWrapper = new PopupToolBarToolWrapper(image,
/// tool, "Open in Textual Model Editor", "textualDSL");
//
...
// for (IPopupToolBarProvider provider :
/// ExtensionPointService.Instance().getAllPopUpBarButtonProvider()){
// //Get the popup bar tool for the model element the tool is built for
// for (PopupToolBarToolWrapper toolWrapper :
/// provider.getPopUpToolbarButtonsForDiagramElement(getHost())){
// //Get all wrappers stored under ID of tool
// List<PopupToolBarToolWrapper> wrappersForGroup =
/// groups2tools.get(toolWrapper.getGroupId());
//
