...
public class MultiplicityPropertiesSectionFilter extends AbstractPropertiesSectionFilter {
  @Override
  public boolean select(Object toTest) {
    ...
    if (service != null)
      return super.select(toTest) && service.getFilterForMultiplicityProperties().select(toTest);
