...
public class DropDownToolbarItem extends ToolbarItem {
  ...
  public DropDownToolbarItem(DragTracker tracker, Image theImage,
      BaseToolbarSelectionEditPolicy hostPolicy, List<ToolBarItemDescriptor> childToolBarItems) {
  ...
  public void handleMouseEntered(MouseEvent event) {
    ...
    for (ToolBarItemDescriptor desc : childToolBarItems) {
      DropDownItemToolbarItem l = new DropDownItemToolbarItem(desc.getDragTracker(), desc.getIcon(),
          desc.getToolTip(), hostPolicy, this);
      menu.add(l);
    }
  ...
  private class CloseMenuJob extends UIJob {
    ...
    public IStatus runInUIThread(IProgressMonitor monitor) {
      if (!menuMotionListener.hovered && menu != null) {
