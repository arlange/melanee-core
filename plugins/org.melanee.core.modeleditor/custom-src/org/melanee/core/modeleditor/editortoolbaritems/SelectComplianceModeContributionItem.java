...
public class SelectComplianceModeContributionItem extends AbstractContributionItem implements Listener {
	...
	public void handleEvent(Event event) {
		...
		Command setComplianceModeCommand = SetCommand.create(editingDomain, domain, PLMPackage.eINSTANCE.getDomain_ComplianceKind()	, ComplianceKind.get(complianceCombo.getSelectionIndex()));
