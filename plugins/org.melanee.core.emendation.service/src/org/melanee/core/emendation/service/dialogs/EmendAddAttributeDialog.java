...
public class EmendAddAttributeDialog extends TitleAreaDialog {
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    preventDuplicatesButton
        .setText("Prevent feature duplicates through emendation (Don't add if it already exists)");
  ...
  private boolean valuesOK() {
    return newDurabilityText.getText().matches("\\-?\\d*")
        && newMutabilityText.getText().matches("\\-?\\d*");
  }
}