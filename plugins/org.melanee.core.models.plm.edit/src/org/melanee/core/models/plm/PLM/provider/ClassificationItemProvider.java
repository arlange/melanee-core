 ...
 * {@link org.melanee.core.models.plm.PLM.Classification} object. <!--
...
public class ClassificationItemProvider extends CorrelationItemProvider {
  ...
  protected void addInstancePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_Classification_instance_feature",
            "_UI_Classification_type"),
        PLMPackage.Literals.CLASSIFICATION__INSTANCE, true, false, true, null, null, null));
  }
  ...
  protected void addTypePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_Classification_type_feature",
            "_UI_Classification_type"),
        PLMPackage.Literals.CLASSIFICATION__TYPE, true, false, true, null, null, null));
  }
  ...
  protected void addKindPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_Classification_kind_feature",
            "_UI_Classification_type"),
        PLMPackage.Literals.CLASSIFICATION__KIND, true, false, false,
        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }

  /**
   * This returns Classification.gif. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @generated
   */
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_Classification_type")
