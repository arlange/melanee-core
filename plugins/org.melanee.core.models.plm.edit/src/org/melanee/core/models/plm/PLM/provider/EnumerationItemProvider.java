...
/**
 * This is the item provider adapter for a {@link org.melanee.core.models.plm.PLM.Enumeration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationItemProvider extends ElementItemProvider {
	/**
	...
	itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Enumeration_literal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Enumeration_literal_feature", "_UI_Enumeration_type"),
				 PLMPackage.Literals.ENUMERATION__LITERAL,
				 true,
				 false,
				 false,
