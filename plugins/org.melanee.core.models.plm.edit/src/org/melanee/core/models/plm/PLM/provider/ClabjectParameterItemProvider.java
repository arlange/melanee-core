...
public class ClabjectParameterItemProvider extends ParameterItemProvider {
  ...
  protected void addDatatypePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(new org.eclipse.emf.edit.provider.ItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_ClabjectParameter_datatype_feature",
            "_UI_ClabjectParameter_type"),
        PLMPackage.Literals.CLABJECT_PARAMETER__DATATYPE, true, false, true, null, null, null) {
      @Override
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_ClabjectParameter_type")
