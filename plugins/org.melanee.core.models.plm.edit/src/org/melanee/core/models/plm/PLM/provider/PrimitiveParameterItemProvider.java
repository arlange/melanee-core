 ...
 * {@link org.melanee.core.models.plm.PLM.PrimitiveParameter} object. <!--
...
public class PrimitiveParameterItemProvider extends ParameterItemProvider {
  ...
  protected void addDatatypePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(new org.eclipse.emf.edit.provider.ItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveParameter_datatype_feature",
            "_UI_PrimitiveParameter_type"),
        PLMPackage.Literals.PRIMITIVE_PARAMETER__DATATYPE, true, false, false,
  ...
  /**
   * This returns PrimitiveParameter.gif. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_PrimitiveParameter_type")
