...
public class ConnectionEndItemProvider extends PropertyItemProvider {
  ...
  protected void addLowerPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_ConnectionEnd_lower_feature",
            "_UI_ConnectionEnd_type"),
        PLMPackage.Literals.CONNECTION_END__LOWER, true, false, false,
  ...
  protected void addUpperPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_ConnectionEnd_upper_feature",
            "_UI_ConnectionEnd_type"),
        PLMPackage.Literals.CONNECTION_END__UPPER, true, false, false,
        ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
  }
  ...
  protected void addNavigablePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_ConnectionEnd_navigable_feature",
            "_UI_ConnectionEnd_type"),
        PLMPackage.Literals.CONNECTION_END__NAVIGABLE, true, false, false,
  ...
  protected void addDestinationPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_ConnectionEnd_destination_feature",
            "_UI_ConnectionEnd_type"),
        PLMPackage.Literals.CONNECTION_END__DESTINATION, true, false, true, null, null, null));
  }

  /**
   * This adds a property descriptor for the Moniker feature. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addMonikerPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_ConnectionEnd_moniker_feature",
            "_UI_ConnectionEnd_type"),
        PLMPackage.Literals.CONNECTION_END__MONIKER, true, false, false,
  ...
  protected void addKindPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_ConnectionEnd_kind_feature",
            "_UI_ConnectionEnd_type"),
        PLMPackage.Literals.CONNECTION_END__KIND, true, false, false,
        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  protected void addTypePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_ConnectionEnd_type_feature",
            "_UI_ConnectionEnd_type"),
        PLMPackage.Literals.CONNECTION_END__TYPE, true, false, true, null, null, null));
  }
  ...
  /**
   * This returns ConnectionEnd.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(PLMPackage.Literals.CONNECTION_END__MULTIPLICITY,
