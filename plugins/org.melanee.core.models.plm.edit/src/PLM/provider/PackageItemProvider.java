...
/**
 * This is the item provider adapter for a {@link PLM.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider extends OwnedElementItemProvider {
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(PLMPackage.Literals.PACKAGE__CONTENT);
    }
  ...
  public String getText(Object object) {
    String label = ((PLM.Package)object).getName();
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(PLM.Package.class)) {
