...
/**
 * This is the item provider adapter for a {@link PLM.ConnectionEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionEndItemProvider extends PropertyItemProvider {
  ...
  public String getText(Object object) {
    String label = ((ConnectionEnd)object).getParsingOrder();
    return label == null || label.length() == 0 ?
      getString("_UI_ConnectionEnd_type") :
      getString("_UI_ConnectionEnd_type") + " " + label;
  }
