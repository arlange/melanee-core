...
/**
 * This is the action bar contributor for the PLM model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PLMActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(PLMEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(PLMEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
