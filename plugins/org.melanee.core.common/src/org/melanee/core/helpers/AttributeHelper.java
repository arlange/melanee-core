...
public class AttributeHelper {
  ...
  /**
   * Converts the value trait of a model element to its java version based on the
   * datatype.
   * 
   * @param attribute
   *          attribute to convert the value of
  ...
  /**
   * Converts the value trait of a model element to its java version based on the
   * datatype. If no datatype is set the vaiue datatype can be infered.
   * 
   * @param attribute
   *          attribute attribute to convert the value of
   * @param inferDatatype
   *          infer the datatype if not set
   * @return A converted value. String if no conversion is possible
   */
